...
class OpenAIGPTConfig(PretrainedConfig):
    """
        This is the configuration class to store the configuration of an :class:`~transformersdiffpruning.OpenAIGPTModel`.
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 40478):
                ...
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformersdiffpruning.CTRLModel`.
            ...
            summary_type (:obj:`string`, optional, defaults to "cls_index"):
                ...
                :class:`~transformersdiffpruning.OpenAIGPTDoubleHeadsModel`.
