...
TRANSFO_XL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformersdiffpruning.TransfoXLConfig`): Model configuration class with all the parameters of the model.
...
TRANSFO_XL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.TransfoXLTokenizer`.
...
class TransfoXLModel(TransfoXLPreTrainedModel):
    ...
    def forward(self, input_ids=None, mems=None, head_mask=None, inputs_embeds=None):
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.TransfoXLConfig`) and inputs:
