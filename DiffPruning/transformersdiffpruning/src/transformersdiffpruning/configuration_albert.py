...
class AlbertConfig(PretrainedConfig):
    r"""
        This is the configuration class to store the configuration of an :class:`~transformersdiffpruning.AlbertModel`.
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 30000):
                ...
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformersdiffpruning.AlbertModel`.
            ...
            type_vocab_size (:obj:`int`, optional, defaults to 2):
                The vocabulary size of the `token_type_ids` passed into :class:`~transformersdiffpruning.AlbertModel`.
