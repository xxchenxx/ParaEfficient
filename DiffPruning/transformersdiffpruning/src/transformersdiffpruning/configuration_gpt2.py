...
class GPT2Config(PretrainedConfig):
    """
        This is the configuration class to store the configuration of a :class:`~transformersdiffpruning.GPT2Model`.
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 50257):
                ...
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformersdiffpruning.GPT2Model`.
            ...
            summary_type (:obj:`string`, optional, defaults to "cls_index"):
                ...
                :class:`~transformersdiffpruning.GPT2DoubleHeadsModel`.
