...
FLAUBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformersdiffpruning.FlaubertConfig`): Model configuration class with all the parameters of the model.
...
FLAUBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.BertTokenizer`.
            See :func:`transformersdiffpruning.PreTrainedTokenizer.encode` and
            :func:`transformersdiffpruning.PreTrainedTokenizer.encode_plus` for details.
...
class FlaubertModel(XLMModel):
    ...
    def forward(
        ...
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.XLMConfig`) and inputs:
...
class FlaubertWithLMHeadModel(XLMWithLMHeadModel):
    """
    This class overrides :class:`~transformersdiffpruning.XLMWithLMHeadModel`. Please check the
...
class FlaubertForSequenceClassification(XLMForSequenceClassification):
    """
    This class overrides :class:`~transformersdiffpruning.XLMForSequenceClassification`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
...
class FlaubertForQuestionAnsweringSimple(XLMForQuestionAnsweringSimple):
    """
    This class overrides :class:`~transformersdiffpruning.XLMForQuestionAnsweringSimple`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
...
class FlaubertForQuestionAnswering(XLMForQuestionAnswering):
    """
    This class overrides :class:`~transformersdiffpruning.XLMForQuestionAnswering`. Please check the
    superclass for the appropriate documentation alongside usage examples.
    """
