...
class TransfoXLConfig(PretrainedConfig):
    """
        This is the configuration class to store the configuration of an :class:`~transformersdiffpruning.TransfoXLModel`.
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 267735):
                ...
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformersdiffpruning.TransfoXLModel`.
