...
ROBERTA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformersdiffpruning.RobertaConfig`): Model configuration class with all the parameters of the
...
ROBERTA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.RobertaTokenizer`.
...
class RobertaModel(BertModel):
    """
    This class overrides :class:`~transformersdiffpruning.BertModel`. Please check the
