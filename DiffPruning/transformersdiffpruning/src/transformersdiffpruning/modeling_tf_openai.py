...
OPENAI_GPT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.GPT2Tokenizer`.
...
class TFOpenAIGPTModel(TFOpenAIGPTPreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        r"""
    Return:
        :obj:`tuple(tf.Tensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.OpenAIGPTConfig`) and inputs:
