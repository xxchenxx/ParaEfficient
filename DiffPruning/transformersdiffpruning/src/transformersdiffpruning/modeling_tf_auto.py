...
class TFAutoModel(object):
    r"""
        :class:`~transformersdiffpruning.TFAutoModel` is a generic model class
...
class TFAutoModelForPreTraining(object):
    r"""
        :class:`~transformersdiffpruning.TFAutoModelForPreTraining` is a generic model class
    ...
    def from_config(cls, config):
        ...
        Args:
            config (:class:`~transformersdiffpruning.PretrainedConfig`):
                ...
                - isInstance of `distilbert` configuration class: :class:`~transformersdiffpruning.TFDistilBertModelForMaskedLM` (DistilBERT model)
                - isInstance of `roberta` configuration class: :class:`~transformersdiffpruning.TFRobertaModelForMaskedLM` (RoBERTa model)
                - isInstance of `bert` configuration class: :class:`~transformersdiffpruning.TFBertForPreTraining` (Bert model)
                - isInstance of `openai-gpt` configuration class: :class:`~transformersdiffpruning.TFOpenAIGPTLMHeadModel` (OpenAI GPT model)
                - isInstance of `gpt2` configuration class: :class:`~transformersdiffpruning.TFGPT2ModelLMHeadModel` (OpenAI GPT-2 model)
                - isInstance of `ctrl` configuration class: :class:`~transformersdiffpruning.TFCTRLModelLMHeadModel` (Salesforce CTRL  model)
                - isInstance of `transfo-xl` configuration class: :class:`~transformersdiffpruning.TFTransfoXLLMHeadModel` (Transformer-XL model)
                - isInstance of `xlnet` configuration class: :class:`~transformersdiffpruning.TFXLNetLMHeadModel` (XLNet model)
                - isInstance of `xlm` configuration class: :class:`~transformersdiffpruning.TFXLMWithLMHeadModel` (XLM model)
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        The model class to instantiate is selected as the first pattern matching
        in the `pretrained_model_name_or_path` string (in the following order):
            - contains `t5`: :class:`~transformersdiffpruning.TFT5ModelWithLMHead` (T5 model)
            - contains `distilbert`: :class:`~transformersdiffpruning.TFDistilBertForMaskedLM` (DistilBERT model)
            - contains `albert`: :class:`~transformersdiffpruning.TFAlbertForMaskedLM` (ALBERT model)
            - contains `roberta`: :class:`~transformersdiffpruning.TFRobertaForMaskedLM` (RoBERTa model)
            - contains `bert`: :class:`~transformersdiffpruning.TFBertForPreTraining` (Bert model)
            - contains `openai-gpt`: :class:`~transformersdiffpruning.TFOpenAIGPTLMHeadModel` (OpenAI GPT model)
            - contains `gpt2`: :class:`~transformersdiffpruning.TFGPT2LMHeadModel` (OpenAI GPT-2 model)
            - contains `transfo-xl`: :class:`~transformersdiffpruning.TFTransfoXLLMHeadModel` (Transformer-XL model)
            - contains `xlnet`: :class:`~transformersdiffpruning.TFXLNetLMHeadModel` (XLNet model)
            - contains `xlm`: :class:`~transformersdiffpruning.TFXLMWithLMHeadModel` (XLM model)
            - contains `ctrl`: :class:`~transformersdiffpruning.TFCTRLLMHeadModel` (Salesforce CTRL model)
        ...
        Args:
            ...
            kwargs: (`optional`) Remaining dictionary of keyword arguments:
                ...
                - If a configuration is not provided, ``kwargs`` will be first passed to the configuration class
                  initialization function (:func:`~transformersdiffpruning.PretrainedConfig.from_pretrained`). Each key of
...
class TFAutoModelWithLMHead(object):
    r"""
        :class:`~transformersdiffpruning.TFAutoModelWithLMHead` is a generic model class
...
class TFAutoModelForSequenceClassification(object):
    r"""
        :class:`~transformersdiffpruning.TFAutoModelForSequenceClassification` is a generic model class
...
class TFAutoModelForQuestionAnswering(object):
    r"""
        :class:`~transformersdiffpruning.TFAutoModelForQuestionAnswering` is a generic model class
