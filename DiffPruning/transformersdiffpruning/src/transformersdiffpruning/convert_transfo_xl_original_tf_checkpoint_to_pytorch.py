...
import transformersdiffpruning.tokenization_transfo_xl as data_utils
...
from transformersdiffpruning.tokenization_transfo_xl import CORPUS_NAME, VOCAB_FILES_NAMES
