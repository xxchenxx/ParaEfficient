...
class FlaubertConfig(XLMConfig):
    """
        ...
        This is the configuration class to store the configuration of a :class:`~transformersdiffpruning.XLMModel`.
        ...
        Args:
            ...
            vocab_size (:obj:`int`, optional, defaults to 30145):
                ...
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformersdiffpruning.FlaubertModel`.
            ...
            summary_type (:obj:`string`, optional, defaults to "first"):
                ...
                :class:`~transformersdiffpruning.XLMForSequenceClassification`.
