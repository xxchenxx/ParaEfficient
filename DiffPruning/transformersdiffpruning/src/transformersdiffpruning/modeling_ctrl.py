...
CTRL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformersdiffpruning.CTRLConfig`): Model configuration class with all the parameters of the model.
...
CTRL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.CTRLTokenizer`.
...
class CTRLModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.CTRLConfig`) and inputs:
