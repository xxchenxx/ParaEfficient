...
class PretrainedConfig(object):
    r""" Base class for all configuration classes.
        ...
        Class attributes (overridden by derived classes):
            ...
            - ``model_type``: a string that identifies the model type, that we serialize into the JSON file, and that we use to recreate the correct object in :class:`~transformersdiffpruning.AutoConfig`.
    ...
    def save_pretrained(self, save_directory):
        ...
        can be re-loaded using the :func:`~transformersdiffpruning.PretrainedConfig.from_pretrained` class method.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs) -> "PretrainedConfig":
        ...
        Instantiate a :class:`~transformersdiffpruning.PretrainedConfig` (or a derived class) from a pre-trained model configuration.
            ...
            pretrained_model_name_or_path (:obj:`string`):
                either:
                  ...
                  - a path to a `directory` containing a configuration file saved using the
                    :func:`~transformersdiffpruning.PretrainedConfig.save_pretrained` method, e.g.: ``./my_model_directory/``.
    ...
    def from_dict(cls, config_dict: Dict, **kwargs) -> "PretrainedConfig":
        ...
        Args:
            config_dict (:obj:`Dict[str, any]`):
                ...
                from a pre-trained checkpoint by leveraging the :func:`~transformersdiffpruning.PretrainedConfig.get_config_dict`
                method.
