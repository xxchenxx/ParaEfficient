...
from transformersdiffpruning.modeling_bert import (
    BertConfig,
    BertIntermediate,
    BertLayer,
    BertOutput,
...
from transformersdiffpruning.modeling_roberta import RobertaForMaskedLM, RobertaForSequenceClassification
