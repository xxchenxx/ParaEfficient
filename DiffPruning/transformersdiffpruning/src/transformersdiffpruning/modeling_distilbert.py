...
DISTILBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformersdiffpruning.DistilBertConfig`): Model configuration class with all the parameters of the model.
...
DISTILBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.DistilBertTokenizer`.
...
class DistilBertModel(DistilBertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, head_mask=None, inputs_embeds=None):
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.DistilBertConfig`) and inputs:
