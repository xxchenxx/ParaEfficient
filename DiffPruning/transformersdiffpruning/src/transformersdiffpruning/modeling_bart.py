...
BART_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformersdiffpruning.BartConfig`): Model configuration class with all the parameters of the model.
...
BART_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.BartTokenizer.encode(text)`.
        ...
        decoder_attention_mask (:obj:`torch.Tensor` of shape :obj:`(batch_size, 1, tgt_seq_len, tgt_seq_len)`, `optional`, defaults to :obj:`None`):
            ...
            If you want to change padding behavior, you should read :func:`~transformersdiffpruning.modeling_bart._prepare_decoder_inputs` and modify.
...
RET_DOCSTRING = r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.BertConfig`) and inputs:
...
class BartForMaskedLM(PretrainedBartModel):
    ...
    Returns:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.RobertaConfig`) and inputs:
...
class BartForSequenceClassification(PretrainedBartModel):
    ...
    Returns:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.BartConfig`) and inputs:
