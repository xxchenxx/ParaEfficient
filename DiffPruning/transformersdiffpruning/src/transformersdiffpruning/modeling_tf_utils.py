...
class TFPreTrainedModel(tf.keras.Model, TFModelUtilsMixin):
    r""" Base class for all TF models.
        ...
        :class:`~transformersdiffpruning.TFPreTrainedModel` takes care of storing the configuration of the models and handles methods for loading/downloading/saving models
