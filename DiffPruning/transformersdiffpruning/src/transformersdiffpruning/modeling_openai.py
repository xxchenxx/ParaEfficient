...
OPENAI_GPT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformersdiffpruning.OpenAIGPTConfig`): Model configuration class with all the parameters of the model.
...
OPENAI_GPT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.OpenAIGPTTokenizer`.
...
class OpenAIGPTModel(OpenAIGPTPreTrainedModel):
    ...
    def forward(
        ...
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.OpenAIGPTConfig`) and inputs:
