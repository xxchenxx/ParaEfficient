...
from transformersdiffpruning.configuration_albert import AlbertConfig
from transformersdiffpruning.modeling_bert import ACT2FN, BertEmbeddings, BertSelfAttention, prune_linear_layer
from transformersdiffpruning.modeling_utils import PreTrainedModel
...
ALBERT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformersdiffpruning.AlbertConfig`): Model configuration class with all the parameters of the model.
...
ALBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`transformersdiffpruning.AlbertTokenizer`.
...
class AlbertModel(AlbertPreTrainedModel):
    ...
    def forward(
        ...
        r"""
    Return:
        :obj:`tuple(torch.FloatTensor)` comprising various elements depending on the configuration (:class:`~transformersdiffpruning.AlbertConfig`) and inputs:
