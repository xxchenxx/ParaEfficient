...
class PreTrainedTokenizer(object):
    ...
    def from_pretrained(cls, *inputs, **kwargs):
        r"""
        Instantiate a :class:`~transformersdiffpruning.PreTrainedTokenizer` (or a derived class) from a predefined tokenizer.
        ...
        Args:
            pretrained_model_name_or_path: either:
                ...
                - a path to a `directory` containing vocabulary files required by the tokenizer, for instance saved using the :func:`~transformersdiffpruning.PreTrainedTokenizer.save_pretrained` method, e.g.: ``./my_model_directory/``.
            ...
            kwargs: (`optional`) keyword arguments: will be passed to the Tokenizer ``__init__`` method. Can be used to set special tokens like ``bos_token``, ``eos_token``, ``unk_token``, ``sep_token``, ``pad_token``, ``cls_token``, ``mask_token``, ``additional_special_tokens``. See parameters in the doc string of :class:`~transformersdiffpruning.PreTrainedTokenizer` for details.
    ...
    def save_pretrained(self, save_directory):
        """ Save the tokenizer vocabulary files together with:
            ...
            This method make sure the full tokenizer can then be re-loaded using the :func:`~transformersdiffpruning.PreTrainedTokenizer.from_pretrained` class method.
        """
    ...
    def save_vocabulary(self, save_directory):
        """ Save the tokenizer vocabulary to a directory. This method does *NOT* save added tokens
            ...
            Please use :func:`~transformersdiffpruning.PreTrainedTokenizer.save_pretrained` `()` to save the full Tokenizer state if you want to reload it using the :func:`~transformersdiffpruning.PreTrainedTokenizer.from_pretrained` class method.
        """
        raise NotImplementedError
        ...
        **kwargs
        ...
        if return_offsets_mapping:
            raise NotImplementedError(
                ...
                "transformersdiffpruning.PreTrainedTokenizerFast."
