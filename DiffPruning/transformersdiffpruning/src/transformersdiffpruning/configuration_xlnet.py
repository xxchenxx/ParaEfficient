...
class XLNetConfig(PretrainedConfig):
    """
        This is the configuration class to store the configuration of a :class:`~transformersdiffpruning.XLNetModel`.
        ...
        Configuration objects inherit from  :class:`~transformersdiffpruning.PretrainedConfig` and can be used
        to control the model outputs. Read the documentation from  :class:`~transformersdiffpruning.PretrainedConfig`
        for more information.

        Args:
            vocab_size (:obj:`int`, optional, defaults to 32000):
                Vocabulary size of the XLNet model. Defines the different tokens that
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformersdiffpruning.XLNetModel`.
            ...
            summary_type (:obj:`string`, optional, defaults to "last"):
                ...
                :class:transformersdiffpruning.XLNetForSequenceClassification` and :class:`~transformersdiffpruning.XLNetForMultipleChoice`.
