...
T5_START_DOCSTRING = r"""    The T5 model was proposed in
    ...
    Parameters:
        config (:class:`~transformersdiffpruning.T5Config`): Model configuration class with all the parameters of the model.
...
T5_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``torch.LongTensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`transformersdiffpruning.T5Tokenizer`.
            See :func:`transformersdiffpruning.PreTrainedTokenizer.encode` and
            :func:`transformersdiffpruning.PreTrainedTokenizer.convert_tokens_to_ids` for details.
