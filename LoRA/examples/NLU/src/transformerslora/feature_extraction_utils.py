...
class BatchFeature(UserDict):
    r"""
    Holds the output of the :meth:`~transformerslora.SequenceFeatureExtractor.pad` and feature extractor specific
    ``__call__`` methods.
    ...
    # Copied from transformerslora.tokenization_utils_base.BatchEncoding.keys
    def keys(self):
        return self.data.keys()

    # Copied from transformerslora.tokenization_utils_base.BatchEncoding.values
    def values(self):
        return self.data.values()

    # Copied from transformerslora.tokenization_utils_base.BatchEncoding.items
    def items(self):
    ...
    @torch_required
    # Copied from transformerslora.tokenization_utils_base.BatchEncoding.to with BatchEncoding->BatchFeature
    def to(self, device: Union[str, "torch.device"]) -> "BatchFeature":
        ...
        Returns:
            :class:`~transformerslora.BatchFeature`: The same instance after modification.
        """
...
class FeatureExtractionMixin:
    ...
    def from_pretrained(
        ...
        r"""
        Instantiate a type of :class:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin` from a feature
        extractor, *e.g.* a derived class of :class:`~transformerslora.SequenceFeatureExtractor`.
        ...
        Args:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                ...
                - a path to a `directory` containing a feature extractor file saved using the
                  :func:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin.save_pretrained` method, e.g.,
                  ``./my_model_directory/``.
        ...
        Returns:
            A feature extractor of type :class:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin`.
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike]):
        ...
        :func:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin.from_pretrained` class method.
    ...
    def get_feature_extractor_dict(
        ...
        feature extractor of type :class:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin` using
        ``from_dict``.
    ...
    def from_dict(cls, feature_extractor_dict: Dict[str, Any], **kwargs) -> PreTrainedFeatureExtractor:
        """
        Instantiates a type of :class:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin` from a Python
        ...
        Args:
            feature_extractor_dict (:obj:`Dict[str, Any]`):
                ...
                :func:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin.to_dict` method.
            kwargs (:obj:`Dict[str, Any]`):
                Additional parameters from which to initialize the feature extractor object.

        Returns:
            :class:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin`: The feature extractor object
    ...
    def from_json_file(cls, json_file: Union[str, os.PathLike]) -> PreTrainedFeatureExtractor:
        """
        Instantiates a feature extractor of type :class:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin`
        ...
        Returns:
            A feature extractor of type :class:`~transformerslora.feature_extraction_utils.FeatureExtractionMixin`: The
