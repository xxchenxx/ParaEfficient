...
class Trainer:
    """
    Trainer is a simple but feature-complete training and eval loop for PyTorch, optimized for 🤗 transformerslora.

    Args:
        model (:class:`~transformerslora.PreTrainedModel` or :obj:`torch.nn.Module`, `optional`):
            The model to train, evaluate or use for predictions. If not provided, a ``model_init`` must be passed.

            .. note::

                :class:`~transformerslora.Trainer` is optimized to work with the :class:`~transformerslora.PreTrainedModel`
                provided by the library. You can still use your own models defined as :obj:`torch.nn.Module` as long as
                they work the same way as the 🤗 Transformers models.
        args (:class:`~transformerslora.TrainingArguments`, `optional`):
            The arguments to tweak for training. Will default to a basic instance of
            :class:`~transformerslora.TrainingArguments` with the ``output_dir`` set to a directory named `tmp_trainer` in
            the current directory if not provided.
        data_collator (:obj:`DataCollator`, `optional`):
            The function to use to form a batch from a list of elements of :obj:`train_dataset` or :obj:`eval_dataset`.
            Will default to :func:`~transformerslora.default_data_collator` if no ``tokenizer`` is provided, an instance of
            :func:`~transformerslora.DataCollatorWithPadding` otherwise.
        ...
        model_init (:obj:`Callable[[], PreTrainedModel]`, `optional`):
            ...
            :meth:`~transformerslora.Trainer.train` will start from a new instance of the model as given by this function.
        ...
        compute_metrics (:obj:`Callable[[EvalPrediction], Dict]`, `optional`):
            ...
            :class:`~transformerslora.EvalPrediction` and return a dictionary string to metric values.
        callbacks (List of :obj:`~transformerslora.TrainerCallback`, `optional`):
        ...
        optimizers (:obj:`Tuple[torch.optim.Optimizer, torch.optim.lr_scheduler.LambdaLR`, `optional`): A tuple
            ...
            :class:`~transformerslora.AdamW` on your model and a scheduler given by
            :func:`~transformerslora.get_linear_schedule_with_warmup` controlled by :obj:`args`.

    Important attributes:

        - **model** -- Always points to the core model. If using a transformers model, it will be a
          :class:`~transformerslora.PreTrainedModel` subclass.
        ...
        **kwargs,
        ...
        Args:
            resume_from_checkpoint (:obj:`str` or :obj:`bool`, `optional`):
                ...
                :class:`~transformerslora.Trainer`. If a :obj:`bool` and equals `True`, load the last checkpoint in
                `args.output_dir` as saved by a previous instance of :class:`~transformerslora.Trainer`. If present,
    ...
    def hyperparameter_search(
        ...
        **kwargs,
        ...
        .. warning::
            ...
            :class:`~transformerslora.Trainer`: we need to reinitialize the model at each new run. This is incompatible
            with the ``optimizers`` argument, so you need to subclass :class:`~transformerslora.Trainer` and override the
            method :meth:`~transformerslora.Trainer.create_optimizer_and_scheduler` for custom optimizer/scheduler.

        Args:
            hp_space (:obj:`Callable[["optuna.Trial"], Dict[str, float]]`, `optional`):
                A function that defines the hyperparameter search space. Will default to
                :func:`~transformerslora.trainer_utils.default_hp_space_optuna` or
                :func:`~transformerslora.trainer_utils.default_hp_space_ray` depending on your backend.
            compute_objective (:obj:`Callable[[Dict[str, float]], float]`, `optional`):
                A function computing the objective to minimize or maximize from the metrics returned by the
                :obj:`evaluate` method. Will default to :func:`~transformerslora.trainer_utils.default_compute_objective`.
            ...
            direction(:obj:`str`, `optional`, defaults to :obj:`"minimize"`):
                ...
                several metrics.
            backend(:obj:`str` or :class:`~transformerslora.training_utils.HPSearchBackend`, `optional`):
        ...
        Returns:
            :class:`transformerslora.trainer_utils.BestRun`: All the information about the best run.
        """
        if backend is None:
    ...
    def floating_point_ops(self, inputs: Dict[str, Union[torch.Tensor, Any]]):
        """
        For models that inherit from :class:`~transformerslora.PreTrainedModel`, uses that method to compute the number of
