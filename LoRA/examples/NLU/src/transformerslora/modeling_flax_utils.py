...
class FlaxPreTrainedModel(ABC):
    ...
    :class:`~transformerslora.FlaxPreTrainedModel` takes care of storing the configuration of the models and handles
            ...
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                Can be either:
                    ...
                    - A path to a `directory` containing model weights saved using
                      :func:`~transformerslora.FlaxPreTrainedModel.save_pretrained`, e.g., ``./my_model_directory/``.
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike]):
        ...
        `:func:`~transformerslora.FlaxPreTrainedModel.from_pretrained`` class method
