...
class TrainingArguments:
    ...
    Using :class:`~transformerslora.HfArgumentParser` we can turn this class into `argparse
    ...
    Parameters:
        ...
        do_train (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether to run training or not. This argument is not directly used by :class:`~transformerslora.Trainer`, it's
        ...
        do_eval (:obj:`bool`, `optional`):
            ...
            :class:`~transformerslora.Trainer`, it's intended to be used by your training/evaluation scripts instead. See
        ...
        do_predict (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            the `example scripts <https://github.com/huggingface/transformers/tree/master/examples>`__ for more
            details.
        evaluation_strategy (:obj:`str` or :class:`~transformerslora.trainer_utils.IntervalStrategy`, `optional`, defaults to :obj:`"no"`):
        ...
        learning_rate (:obj:`float`, `optional`, defaults to 5e-5):
            The initial learning rate for :class:`~transformerslora.AdamW` optimizer.
        weight_decay (:obj:`float`, `optional`, defaults to 0):
            The weight decay to apply (if not zero) to all layers except all bias and LayerNorm weights in
            :class:`~transformerslora.AdamW` optimizer.
        adam_beta1 (:obj:`float`, `optional`, defaults to 0.9):
            The beta1 hyperparameter for the :class:`~transformerslora.AdamW` optimizer.
        adam_beta2 (:obj:`float`, `optional`, defaults to 0.999):
            The beta2 hyperparameter for the :class:`~transformerslora.AdamW` optimizer.
        adam_epsilon (:obj:`float`, `optional`, defaults to 1e-8):
            The epsilon hyperparameter for the :class:`~transformerslora.AdamW` optimizer.
        ...
        lr_scheduler_type (:obj:`str` or :class:`~transformerslora.SchedulerType`, `optional`, defaults to :obj:`"linear"`):
            The scheduler type to use. See the documentation of :class:`~transformerslora.SchedulerType` for all possible
            values.
        ...
        logging_strategy (:obj:`str` or :class:`~transformerslora.trainer_utils.IntervalStrategy`, `optional`, defaults to :obj:`"steps"`):
        ...
        save_strategy (:obj:`str` or :class:`~transformerslora.trainer_utils.IntervalStrategy`, `optional`, defaults to :obj:`"steps"`):
        ...
        seed (:obj:`int`, `optional`, defaults to 42):
            ...
            :func:`~transformerslora.Trainer.model_init` function to instantiate the model if it has some randomly
        ...
        disable_tqdm (:obj:`bool`, `optional`):
            ...
            :class:`~transformerslora.notebook.NotebookTrainingTracker` in Jupyter Notebooks. Will default to :obj:`True`
        ...
        remove_unused_columns (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            (Note that this behavior is not implemented for :class:`~transformerslora.TFTrainer` yet.)
        ...
        sharded_ddp (:obj:`bool`, :obj:`str` or list of :class:`~transformerslora.trainer_utils.ShardedDDPOption`, `optional`, defaults to :obj:`False`):
        ...
        adafactor (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not to use the :class:`~transformerslora.Adafactor` optimizer instead of
            :class:`~transformerslora.AdamW`.
    ...
    def __post_init__(self):
        ...
        if isinstance(self.evaluation_strategy, EvaluationStrategy):
            warnings.warn(
                "using `EvaluationStrategy` for `evaluation_strategy` is deprecated and will be removed in version 5 of 🤗 transformerslora. Use `IntervalStrategy` instead",
                FutureWarning,
            )
