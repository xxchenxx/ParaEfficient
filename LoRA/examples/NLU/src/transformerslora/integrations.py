...
class TensorBoardCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that sends the logs to `TensorBoard
...
class WandbCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that sends the logs to `Weight and Biases <https://www.wandb.com/>`__.
    """
...
class CometCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that sends the logs to `Comet ML <https://www.comet.ml/site/>`__.
    """
...
class AzureMLCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that sends the logs to `AzureML
...
class MLflowCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that sends the logs to `MLflow <https://www.mlflow.org/>`__.
    """
