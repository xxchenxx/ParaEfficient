...
class TFPreTrainedModel(tf.keras.Model, TFModelUtilsMixin, TFGenerationMixin):
    ...
    :class:`~transformerslora.TFPreTrainedModel` takes care of storing the configuration of the models and handles methods
    ...
    def serving_output(output):
        ...
        Args:
            output (:obj:`~transformerslora.TFBaseModelOutput`):
    ...
    def save_pretrained(self, save_directory, saved_model=False, version=1):
        ...
        :func:`~transformerslora.TFPreTrainedModel.from_pretrained` class method.
        ...
        Parameters:
            ...
            config (:obj:`Union[PretrainedConfig, str]`, `optional`):
                Can be either:
                    ...
                    - a string valid as input to :func:`~transformerslora.PretrainedConfig.from_pretrained`.
                ...
                be automatically loaded when:
                    ...
                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :func:`~transformerslora.TFPreTrainedModel.save_pretrained` and is reloaded
