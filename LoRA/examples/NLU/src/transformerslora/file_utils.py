...
def add_start_docstrings_to_model_forward(*docstr):
    def docstring_decorator(fn):
        class_name = ":class:`~transformerslora.{}`".format(fn.__qualname__.split(".")[0])
...
PT_RETURN_INTRODUCTION = r"""
    Returns:
        ...
        comprising various elements depending on the configuration (:class:`~transformerslora.{config_class}`) and inputs.
...
TF_RETURN_INTRODUCTION = r"""
    Returns:
        ...
        various elements depending on the configuration (:class:`~transformerslora.{config_class}`) and inputs.
...
class ModelOutput(OrderedDict):
    ...
    .. warning::
        You can't unpack a :obj:`ModelOutput` directly. Use the :meth:`~transformerslora.file_utils.ModelOutput.to_tuple`
