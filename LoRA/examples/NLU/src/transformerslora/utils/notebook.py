...
class NotebookProgressBar:
    ...
    Args:
        ...
        leave (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            :meth:`~transformerslora.utils.notebook.NotebookProgressBar.close` method to make the bar disappear.
        parent (:class:`~transformerslora.notebook.NotebookTrainingTracker`, `optional`):
            A parent object (like :class:`~transformerslora.utils.notebook.NotebookTrainingTracker`) that spawns progress
...
class NotebookTrainingTracker(NotebookProgressBar):
    ...
    Args:
        ...
        column_names (:obj:`List[str]`, `optional`):
            ...
            :meth:`~transformerslora.utils.notebook.NotebookTrainingTracker.write_line` if not set).
    """
...
class NotebookProgressCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that displays the progress of training or evaluation, optimized for
