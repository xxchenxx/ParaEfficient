...
class TFTrainer:
    """
    TFTrainer is a simple but feature-complete training and eval loop for TensorFlow, optimized for 🤗 transformerslora.

    Args:
        model (:class:`~transformerslora.TFPreTrainedModel`):
            The model to train, evaluate or use for predictions.
        args (:class:`~transformerslora.TFTrainingArguments`):
        ...
        optimizers (:obj:`Tuple[tf.keras.optimizers.Optimizer, tf.keras.optimizers.schedules.LearningRateSchedule]`, `optional`):
            ...
            :class:`~transformerslora.AdamWeightDecay`. The scheduler will default to an instance of
            :class:`tf.keras.optimizers.schedules.PolynomialDecay` if :obj:`args.num_warmup_steps` is 0 else an
            instance of :class:`~transformerslora.WarmUp`.
    """
    ...
    def prediction_loop(
        ...
        """
        Prediction/evaluation loop, shared by :func:`~transformerslora.TFTrainer.evaluate` and
        :func:`~transformerslora.TFTrainer.predict`.
