...
class TrainerState:
    """
    A class containing the :class:`~transformerslora.Trainer` inner state that will be saved along the model and optimizer
    when checkpointing and passed to the :class:`~transformerslora.TrainerCallback`.
...
class TrainerControl:
    """
    A class that handles the :class:`~transformerslora.Trainer` control flow. This class is used by the
    :class:`~transformerslora.TrainerCallback` to activate some switches in the training loop.
...
class TrainerCallback:
    ...
    Args:
        args (:class:`~transformerslora.TrainingArguments`):
            The training arguments used to instantiate the :class:`~transformerslora.Trainer`.
        state (:class:`~transformerslora.TrainerState`):
            The current state of the :class:`~transformerslora.Trainer`.
        control (:class:`~transformerslora.TrainerControl`):
            The object that is returned to the :class:`~transformerslora.Trainer` and can be used to make some decisions.
        model (:class:`~transformerslora.PreTrainedModel` or :obj:`torch.nn.Module`):
            The model being trained.
        tokenizer (:class:`~transformerslora.PreTrainedTokenizer`):
    ...
    def on_init_end(self, args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the end of the initialization of the :class:`~transformerslora.Trainer`.
        """
        pass
...
class DefaultFlowCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that handles the default flow of the training loop for logs, evaluation
    and checkpoints.
    """
...
class ProgressCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that displays the progress of training or evaluation.
    """
...
class PrinterCallback(TrainerCallback):
    """
    A bare :class:`~transformerslora.TrainerCallback` that just prints the logs.
    """
...
class EarlyStoppingCallback(TrainerCallback):
    """
    A :class:`~transformerslora.TrainerCallback` that handles early stopping.
    ...
    This callback depends on :class:`~transformerslora.TrainingArguments` argument `load_best_model_at_end` functionality
    to set best_metric in :class:`~transformerslora.TrainerState`.
    """
