...
class GenerationMixin:
    ...
    :class:`~transformerslora.PreTrainedModel`.
    """

    def prepare_inputs_for_generation(self, input_ids: torch.LongTensor, **kwargs) -> Dict[str, Any]:
        """
        Implement in subclasses of :class:`~transformerslora.PreTrainedModel` for custom behavior to prepare inputs in the
        generate method.
        """
    ...
    def adjust_logits_during_generation(self, logits: torch.FloatTensor, **kwargs) -> torch.FloatTensor:
        """
        Implement in subclasses of :class:`~transformerslora.PreTrainedModel` for custom behavior to adjust the logits in
        the generate method.
        """
        return logits
    ...
    def _get_logits_warper(
        ...
        """
        This class returns a :obj:`~transformerslora.LogitsProcessorList` list object that contains all relevant
        :obj:`~transformerslora.LogitsWarper` instances used for multinomial sampling.
        """
    ...
    def _get_logits_processor(
        ...
        """
        This class returns a :obj:`~transformerslora.LogitsProcessorList` list object that contains all relevant
        :obj:`~transformerslora.LogitsProcessor` instances used to modify the scores of the language model head.
        """
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        attribute of the same name inside the :class:`~transformerslora.PretrainedConfig` of the model. The default values
        ...
        Return:
            :class:`~transformerslora.file_utils.ModelOutput` or :obj:`torch.LongTensor`: A
            :class:`~transformerslora.file_utils.ModelOutput` (if ``return_dict_in_generate=True`` or when
            ``config.return_dict_in_generate=True``) or a :obj:`torch.FloatTensor`.

                If the model is `not` an encoder-decoder model (``model.config.is_encoder_decoder=False``), the
                possible :class:`~transformerslora.file_utils.ModelOutput` types are:

                    - :class:`~transformerslora.generation_utils.GreedySearchDecoderOnlyOutput`,
                    - :class:`~transformerslora.generation_utils.SampleDecoderOnlyOutput`,
                    - :class:`~transformerslora.generation_utils.BeamSearchDecoderOnlyOutput`,
                    - :class:`~transformerslora.generation_utils.BeamSampleDecoderOnlyOutput`

                If the model is an encoder-decoder model (``model.config.is_encoder_decoder=True``), the possible
                :class:`~transformerslora.file_utils.ModelOutput` types are:

                    - :class:`~transformerslora.generation_utils.GreedySearchEncoderDecoderOutput`,
                    - :class:`~transformerslora.generation_utils.SampleEncoderDecoderOutput`,
                    - :class:`~transformerslora.generation_utils.BeamSearchEncoderDecoderOutput`,
                    - :class:`~transformerslora.generation_utils.BeamSampleEncoderDecoderOutput`
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            logits_processor (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~transformerslora.LogitsProcessorList`. List of instances of class derived from
                :class:`~transformerslora.LogitsProcessor` used to modify the prediction scores of the language modeling
                head applied at each generation step.
            stopping_criteria (:obj:`StoppingCriteriaList`, `optional`):
                An instance of :class:`~transformerslora.StoppingCriteriaList`. List of instances of class derived from
                :class:`~transformerslora.StoppingCriteria` used to tell if the generation loop should stop.
            max_length (:obj:`int`, `optional`, defaults to 20):
                The maximum length of the sequence to be generated.
            pad_token_id (:obj:`int`, `optional`):
                The id of the `padding` token.
        ...
        Return:
            :class:`~transformerslora.generation_utils.GreedySearchDecoderOnlyOutput`,
            :class:`~transformerslora.generation_utils.GreedySearchEncoderDecoderOutput` or obj:`torch.LongTensor`: A
            :obj:`torch.LongTensor` containing the generated tokens (default behaviour) or a
            :class:`~transformerslora.generation_utils.GreedySearchDecoderOnlyOutput` if
            ``model.config.is_encoder_decoder=False`` and ``return_dict_in_generate=True`` or a
            :class:`~transformerslora.generation_utils.GreedySearchEncoderDecoderOutput` if
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            logits_warper (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~transformerslora.LogitsProcessorList`. List of instances of class derived from
                :class:`~transformerslora.LogitsWarper` used to warp the prediction score distribution of the language
        ...
        Return:
            :class:`~transformerslora.generation_utils.SampleDecoderOnlyOutput`,
            :class:`~transformerslora.generation_utils.SampleEncoderDecoderOutput` or obj:`torch.LongTensor`: A
            :obj:`torch.LongTensor` containing the generated tokens (default behaviour) or a
            :class:`~transformerslora.generation_utils.SampleDecoderOnlyOutput` if
            ``model.config.is_encoder_decoder=False`` and ``return_dict_in_generate=True`` or a
            :class:`~transformerslora.generation_utils.SampleEncoderDecoderOutput` if
            ``model.config.is_encoder_decoder=True``.
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            beam_scorer (:obj:`BeamScorer`):
                An derived instance of :class:`~transformerslora.BeamScorer` that defines how beam hypotheses are
                constructed, stored and sorted during generation. For more information, the documentation of
                :class:`~transformerslora.BeamScorer` should be read.
            logits_processor (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~transformerslora.LogitsProcessorList`. List of instances of class derived from
                :class:`~transformerslora.LogitsProcessor` used to modify the prediction scores of the language modeling
                head applied at each generation step.
        ...
        Return:
            :class:`~transformerslora.generation_utilsBeamSearchDecoderOnlyOutput`,
            :class:`~transformerslora.generation_utils.BeamSearchEncoderDecoderOutput` or obj:`torch.LongTensor`: A
            :obj:`torch.LongTensor` containing the generated tokens (default behaviour) or a
            :class:`~transformerslora.generation_utils.BeamSearchDecoderOnlyOutput` if
            ``model.config.is_encoder_decoder=False`` and ``return_dict_in_generate=True`` or a
            :class:`~transformerslora.generation_utils.BeamSearchEncoderDecoderOutput` if
            ``model.config.is_encoder_decoder=True``.
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
                ...
                :obj:`torch.LongTensor` of shape :obj:`(1,)`.
            beam_scorer (:obj:`BeamScorer`):
                A derived instance of :class:`~transformerslora.BeamScorer` that defines how beam hypotheses are
                constructed, stored and sorted during generation. For more information, the documentation of
                :class:`~transformerslora.BeamScorer` should be read.
            logits_processor (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~transformerslora.LogitsProcessorList`. List of instances of class derived from
        ...
        Return:
            :class:`~transformerslora.generation_utils.BeamSampleDecoderOnlyOutput`,
            :class:`~transformerslora.generation_utils.BeamSampleEncoderDecoderOutput` or obj:`torch.LongTensor`: A
            :obj:`torch.LongTensor` containing the generated tokens (default behaviour) or a
            :class:`~transformerslora.generation_utils.BeamSampleDecoderOnlyOutput` if
            ``model.config.is_encoder_decoder=False`` and ``return_dict_in_generate=True`` or a
            :class:`~transformerslora.generation_utils.BeamSampleEncoderDecoderOutput` if
            ``model.config.is_encoder_decoder=True``.
