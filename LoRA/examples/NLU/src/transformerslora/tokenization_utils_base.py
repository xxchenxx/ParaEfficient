...
class BatchEncoding(UserDict):
    """
    Holds the output of the :meth:`~transformerslora.tokenization_utils_base.PreTrainedTokenizerBase.encode_plus` and
    :meth:`~transformerslora.tokenization_utils_base.PreTrainedTokenizerBase.batch_encode` methods (tokens,
    attention_masks, etc).
    ...
    def n_sequences(self) -> Optional[int]:
        ...
        :class:`~transformerslora.BatchEncoding`. Currently can be one of :obj:`None` (unknown), :obj:`1` (a single
    ...
    def is_fast(self) -> bool:
        """
        :obj:`bool`: Indicate whether this :class:`~transformerslora.BatchEncoding` was generated from the result of a
        :class:`~transformerslora.PreTrainedTokenizerFast` or not.
        """
    ...
    def word_to_tokens(
        ...
        Token spans are returned as a :class:`~transformerslora.tokenization_utils_base.TokenSpan` with:
        ...
        Returns:
            Optional :class:`~transformerslora.tokenization_utils_base.TokenSpan` Span of tokens in the encoded sequence.
    ...
    def token_to_chars(self, batch_or_token_index: int, token_index: Optional[int] = None) -> CharSpan:
        ...
        Character spans are returned as a :class:`~transformerslora.tokenization_utils_base.CharSpan` with:
        ...
        Returns:
            :class:`~transformerslora.tokenization_utils_base.CharSpan`: Span of characters in the original string.
        """
    ...
    def convert_to_tensors(
        ...
        Args:
            tensor_type (:obj:`str` or :class:`~transformerslora.file_utils.TensorType`, `optional`):
                The type of tensors to use. If :obj:`str`, should be one of the values of the enum
                :class:`~transformerslora.file_utils.TensorType`. If :obj:`None`, no modification is done.
    ...
    def to(self, device: Union[str, "torch.device"]) -> "BatchEncoding":
        ...
        Returns:
            :class:`~transformerslora.BatchEncoding`: The same instance after modification.
        """
...
class SpecialTokensMixin:
    """
    A mixin derived by :class:`~transformerslora.PreTrainedTokenizer` and :class:`~transformerslora.PreTrainedTokenizerFast` to
    ...
    def add_special_tokens(self, special_tokens_dict: Dict[str, Union[str, AddedToken]]) -> int:
        ...
        :class:`~transformerslora.BertTokenizer` :obj:`cls_token` is already registered to be :obj`'[CLS]'` and XLM's one
    ...
    def add_tokens(
        ...
        .. Note::
            ...
            In order to do that, please use the :meth:`~transformerslora.PreTrainedModel.resize_token_embeddings` method.
...
ENCODE_KWARGS_DOCSTRING = r"""
            ...
            padding (:obj:`bool`, :obj:`str` or :class:`~transformerslora.file_utils.PaddingStrategy`, `optional`, defaults to :obj:`False`):
                ...
                * :obj:`False` or :obj:`'do_not_pad'` (default): No padding (i.e., can output a batch with sequences of
                  different lengths).
            truncation (:obj:`bool`, :obj:`str` or :class:`~transformerslora.tokenization_utils_base.TruncationStrategy`, `optional`, defaults to :obj:`False`):
            ...
            return_tensors (:obj:`str` or :class:`~transformerslora.file_utils.TensorType`, `optional`):
...
ENCODE_PLUS_ADDITIONAL_KWARGS_DOCSTRING = r"""
            ...
            return_offsets_mapping (:obj:`bool`, `optional`, defaults to :obj:`False`):
                ...
                :class:`~transformerslora.PreTrainedTokenizerFast`, if using Python's tokenizer, this method will raise
        ...
        Return:
            :class:`~transformerslora.BatchEncoding`: A :class:`~transformerslora.BatchEncoding` with the following fields:
...
INIT_TOKENIZER_DOCSTRING = r"""
    Class attributes (overridden by derived classes)
        ...
        - **pretrained_init_configuration** (:obj:`Dict[str, Dict[str, Any]]`) -- A dictionary with, as keys, the
          ...
          tokenizer with the :meth:`~transformerslora.tokenization_utils_base.PreTrainedTokenizerBase.from_pretrained`
          method.
    ...
    Args:
        model_max_length (:obj:`int`, `optional`):
            ...
            loaded with :meth:`~transformerslora.tokenization_utils_base.PreTrainedTokenizerBase.from_pretrained`, this
...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    """
    Base class for :class:`~transformerslora.PreTrainedTokenizer` and :class:`~transformerslora.PreTrainedTokenizerFast`.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], *init_inputs, **kwargs):
        r"""
        Instantiate a :class:`~transformerslora.tokenization_utils_base.PreTrainedTokenizerBase` (or a derived class) from
        ...
        Args:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                ...
                - A path to a `directory` containing vocabulary files required by the tokenizer, for instance saved
                  using the :meth:`~transformerslora.tokenization_utils_base.PreTrainedTokenizerBase.save_pretrained`
    ...
    def save_pretrained(
        ...
        :meth:`~transformerslora.tokenization_utils_base.PreTrainedTokenizer.from_pretrained` class method.

        .. Note::
            A "fast" tokenizer (instance of :class:`transformerslora.PreTrainedTokenizerFast`) saved with this method will
            not be possible to load back in a "slow" tokenizer, i.e. in a :class:`transformerslora.PreTrainedTokenizer`
            instance. It can only be loaded in a "fast" tokenizer, i.e. in a
            :class:`transformerslora.PreTrainedTokenizerFast` instance.
    ...
    def _save_pretrained(
        ...
        specific :meth:`~transformerslora.tokenization_utils_fast.PreTrainedTokenizerFast._save_pretrained`
        """
    ...
    def save_vocabulary(self, save_directory: str, filename_prefix: Optional[str] = None) -> Tuple[str]:
        ...
        :meth:`~transformerslora.PreTrainedTokenizerFast._save_pretrained` to save the whole state of the tokenizer.
    ...
    def tokenize(self, text: str, pair: Optional[str] = None, add_special_tokens: bool = False, **kwargs) -> List[str]:
        ...
        Args:
            ...
            kwargs (additional keyword arguments, `optional`):
                ...
                :meth:`~transformerslora.PreTrainedTokenizerBase.__call__`
    ...
    def pad(
        ...
        Args:
            encoded_inputs (:class:`~transformerslora.BatchEncoding`, list of :class:`~transformerslora.BatchEncoding`, :obj:`Dict[str, List[int]]`, :obj:`Dict[str, List[List[int]]` or :obj:`List[Dict[str, List[int]]]`):
                Tokenized inputs. Can represent one input (:class:`~transformerslora.BatchEncoding` or :obj:`Dict[str,
                List[int]]`) or a batch of tokenized inputs (list of :class:`~transformerslora.BatchEncoding`, `Dict[str,
                List[List[int]]]` or `List[Dict[str, List[int]]]`) so you can use this method during preprocessing as
                well as in a PyTorch Dataloader collate function.

                Instead of :obj:`List[int]` you can have tensors (numpy arrays, PyTorch tensors or TensorFlow tensors),
                see the note above for the return type.
            padding (:obj:`bool`, :obj:`str` or :class:`~transformerslora.file_utils.PaddingStrategy`, `optional`, defaults to :obj:`True`):
    ...
    def truncate_sequences(
        ...
        Args:
            ...
            truncation_strategy (:obj:`str` or :class:`~transformerslora.tokenization_utils_base.TruncationStrategy`, `optional`, defaults to :obj:`False`):
        ...
        **kwargs,
        ...
        Arguments:
            ...
            return_tensors (:obj:`str` or :class:`~transformerslora.file_utils.TensorType`, `optional`):
                ...
                * :obj:`'pt'`: Return PyTorch :obj:`torch.Tensor` objects.
                * :obj:`'np'`: Return Numpy :obj:`np.ndarray` objects.
            truncation (:obj:`bool`, :obj:`str` or :class:`~transformerslora.tokenization_utils_base.TruncationStrategy`, `optional`, defaults to :obj:`True`):
                Activates and controls truncation. Accepts the following values:
        ...
        """
        warnings.warn(
            "`prepare_seq2seq_batch` is deprecated and will be removed in version 5 of 🤗 transformerslora. Use the "
