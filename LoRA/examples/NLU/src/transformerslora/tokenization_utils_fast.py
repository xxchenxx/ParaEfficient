...
class PreTrainedTokenizerFast(PreTrainedTokenizerBase):
    ...
    Inherits from :class:`~transformerslora.tokenization_utils_base.PreTrainedTokenizerBase`.
    ...
    def set_truncation_and_padding(
        ...
        Args:
            padding_strategy (:class:`~transformerslora.file_utils.PaddingStrategy`):
                The kind of padding that will be applied to the input
            truncation_strategy (:class:`~transformerslora.tokenization_utils_base.TruncationStrategy`):
    ...
    def _save_pretrained(
        ...
        specific :meth:`~transformerslora.PreTrainedTokenizerFast._save_pretrained`
        """
