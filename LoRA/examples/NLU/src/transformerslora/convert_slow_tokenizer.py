...
def convert_slow_tokenizer(transformer_tokenizer) -> Tokenizer:
    ...
    Args:
        transformer_tokenizer (:class:`~transformerslora.tokenization_utils_base.PreTrainedTokenizer`):
            Instance of a slow tokenizer to convert in the backend tokenizer for
            :class:`~transformerslora.tokenization_utils_base.PreTrainedTokenizerFast`.
