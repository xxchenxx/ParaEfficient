...
PROCESS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size * num_beams, sequence_length)`):
            ...
            Indices can be obtained using any class inheriting from :class:`~transformerslora.PretrainedTokenizer`. See
...
class BeamScorer(ABC):
    """
    Abstract base class for all beam scorers that are used for :meth:`~transformerslora.PretrainedModel.beam_search` and
    :meth:`~transformerslora.PretrainedModel.beam_sample`.
    """
...
class BeamSearchScorer(BeamScorer):
    r"""
    :class:`transformerslora.BeamScorer` implementing standard beam search decoding.
