...
def _list_model_options(indent, config_to_class=None, use_model_types=True):
    ...
    if use_model_types:
        ...
        lines = [
            f"{indent}- **{model_type}** -- :class:`~transformerslora.{cls_name}` ({MODEL_NAMES_MAPPING[model_type]} model)"
        ...
        lines = [
            f"{indent}- :class:`~transformerslora.{config_name}` configuration class: :class:`~transformerslora.{cls_name}` ({config_to_model_name[config_name]} model)"
...
class AutoConfig:
    ...
    when created with the :meth:`~transformerslora.AutoConfig.from_pretrained` class method.
            ...
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                Can be either:
                    ...
                    - A path to a `directory` containing a configuration file saved using the
                      :meth:`~transformerslora.PretrainedConfig.save_pretrained` method, or the
                      :meth:`~transformerslora.PreTrainedModel.save_pretrained` method, e.g., ``./my_model_directory/``.
