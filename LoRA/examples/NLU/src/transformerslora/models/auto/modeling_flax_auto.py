...
class FlaxAutoModel(object):
    r"""
    :class:`~transformerslora.FlaxAutoModel` is a generic model class that will be instantiated as one of the base model
    ...
    def from_config(cls, config):
        ...
        Args:
            config (:class:`~transformerslora.PretrainedConfig`):
                ...
                - isInstance of `roberta` configuration class: :class:`~transformerslora.FlaxRobertaModel` (RoBERTa model)
                - isInstance of `bert` configuration class: :class:`~transformerslora.FlaxBertModel` (Bert model
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        `pretrained_model_name_or_path` string (in the following order):
            ...
            - contains `roberta`: :class:`~transformerslora.FlaxRobertaModel` (RoBERTa model)
            - contains `bert`: :class:`~transformerslora.FlaxBertModel` (Bert model)
        ...
        Args:
            ...
            config: (`optional`) instance of a class derived from :class:`~transformerslora.PretrainedConfig`:
                Configuration for the model to use instead of an automatically loaded configuration. Configuration can
                be automatically loaded when:

                - the model is a model provided by the library (loaded with the ``shortcut-name`` string of a
                  pretrained model), or
                - the model was saved using :func:`~transformerslora.FlaxPreTrainedModel.save_pretrained` and is reloaded
