...
AUTO_MODEL_PRETRAINED_DOCSTRING = r"""
        ...
        Args:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                Can be either:
                    ...
                    - A path to a `directory` containing model weights saved using
                      :func:`~transformerslora.PreTrainedModel.save_pretrained`, e.g., ``./my_model_directory/``.
            ...
            config (:class:`~transformerslora.PretrainedConfig`, `optional`):
                Configuration for the model to use instead of an automatically loaded configuration. Configuration can
                be automatically loaded when:

                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :meth:`~transformerslora.PreTrainedModel.save_pretrained` and is reloaded
            ...
            state_dict (`Dict[str, torch.Tensor]`, `optional`):
                ...
                :func:`~transformerslora.PreTrainedModel.save_pretrained` and
                :func:`~transformerslora.PreTrainedModel.from_pretrained` is not a simpler option.
            ...
            kwargs (additional keyword arguments, `optional`):
                ...
                automatically loaded:
                    ...
                    - If a configuration is not provided, ``kwargs`` will be first passed to the configuration class
                      initialization function (:func:`~transformerslora.PretrainedConfig.from_pretrained`). Each key of
...
class AutoModel:
    ...
    created with the :meth:`~transformerslora.AutoModel.from_pretrained` class method or the
    :meth:`~transformerslora.AutoModel.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            ...
            model's configuration. Use :meth:`~transformerslora.AutoModel.from_pretrained` to load the model weights.

        Args:
            config (:class:`~transformerslora.PretrainedConfig`):
...
class AutoModelForPreTraining:
    ...
    :meth:`~transformerslora.AutoModelForPreTraining.from_pretrained` class method or the
    :meth:`~transformerslora.AutoModelForPreTraining.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForPreTraining.from_pretrained` to load the model
            weights.
...
class AutoModelWithLMHead:
    ...
    language modeling head---when created with the :meth:`~transformerslora.AutoModelWithLMHead.from_pretrained` class
    method or the :meth:`~transformerslora.AutoModelWithLMHead.from_config` class method.
    ...
    .. warning::
        ...
        :class:`~transformerslora.AutoModelForCausalLM` for causal language models,
        :class:`~transformerslora.AutoModelForMaskedLM` for masked language models and
        :class:`~transformerslora.AutoModelForSeq2SeqLM` for encoder-decoder models.
    """
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelWithLMHead.from_pretrained` to load the model
            weights.
...
class AutoModelForCausalLM:
    ...
    language modeling head---when created with the :meth:`~transformerslora.AutoModelForCausalLM.from_pretrained` class
    method or the :meth:`~transformerslora.AutoModelForCausalLM.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForCausalLM.from_pretrained` to load the model
            weights.
...
class AutoModelForMaskedLM:
    ...
    language modeling head---when created with the :meth:`~transformerslora.AutoModelForMaskedLM.from_pretrained` class
    method or the :meth:`~transformerslora.AutoModelForMaskedLM.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForMaskedLM.from_pretrained` to load the model
            weights.
...
class AutoModelForSeq2SeqLM:
    ...
    :meth:`~transformerslora.AutoModelForSeq2SeqLM.from_pretrained` class method or the
    :meth:`~transformerslora.AutoModelForSeq2SeqLM.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForSeq2SeqLM.from_pretrained` to load the model
            weights.
...
class AutoModelForSequenceClassification:
    ...
    :meth:`~transformerslora.AutoModelForSequenceClassification.from_pretrained` class method or the
    :meth:`~transformerslora.AutoModelForSequenceClassification.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForSequenceClassification.from_pretrained` to load
            the model weights.
...
class AutoModelForQuestionAnswering:
    r"""
    This is a generic model class that will be instantiated as one of the model classes of the library---with a
    question answering head---when created with the :meth:`~transformerslora.AutoModeForQuestionAnswering.from_pretrained`
    class method or the :meth:`~transformerslora.AutoModelForQuestionAnswering.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForQuestionAnswering.from_pretrained` to load the
            model weights.
...
class AutoModelForTableQuestionAnswering:
    ...
    :meth:`~transformerslora.AutoModeForTableQuestionAnswering.from_pretrained` class method or the
    :meth:`~transformerslora.AutoModelForTableQuestionAnswering.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForTableQuestionAnswering.from_pretrained` to load
            the model weights.
...
class AutoModelForTokenClassification:
    ...
    classification head---when created with the :meth:`~transformerslora.AutoModelForTokenClassification.from_pretrained`
    class method or the :meth:`~transformerslora.AutoModelForTokenClassification.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForTokenClassification.from_pretrained` to load
            the model weights.
...
class AutoModelForMultipleChoice:
    ...
    :meth:`~transformerslora.AutoModelForMultipleChoice.from_pretrained` class method or the
    :meth:`~transformerslora.AutoModelForMultipleChoice.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForMultipleChoice.from_pretrained` to load the
            model weights.
...
class AutoModelForNextSentencePrediction:
    ...
    :meth:`~transformerslora.AutoModelForNextSentencePrediction.from_pretrained` class method or the
    :meth:`~transformerslora.AutoModelForNextSentencePrediction.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.AutoModelForNextSentencePrediction.from_pretrained` to load
            the model weights.
