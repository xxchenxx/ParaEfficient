...
class TFAutoModel(object):
    ...
    created with the when created with the :meth:`~transformerslora.TFAutoModel.from_pretrained` class method or the
    :meth:`~transformerslora.TFAutoModel.from_config` class method.
    ...
    def from_config(cls, config, **kwargs):
        ...
        Note:
            ...
            model's configuration. Use :meth:`~transformerslora.TFAutoModel.from_pretrained` to load the model weights.
...
class TFAutoModelForPreTraining(object):
    ...
    :meth:`~transformerslora.TFAutoModelForPreTraining.from_pretrained` class method or the
    :meth:`~transformerslora.TFAutoModelForPreTraining.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForPreTraining.from_pretrained` to load the
            model weights.
...
class TFAutoModelWithLMHead(object):
    ...
    language modeling head---when created with the :meth:`~transformerslora.TFAutoModelWithLMHead.from_pretrained` class
    method or the :meth:`~transformerslora.TFAutoModelWithLMHead.from_config` class method.
    ...
    .. warning::
        ...
        :class:`~transformerslora.TFAutoModelForCausalLM` for causal language models,
        :class:`~transformerslora.TFAutoModelForMaskedLM` for masked language models and
        :class:`~transformerslora.TFAutoModelForSeq2SeqLM` for encoder-decoder models.
    """
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelWithLMHead.from_pretrained` to load the model
            weights.
...
class TFAutoModelForCausalLM:
    ...
    language modeling head---when created with the :meth:`~transformerslora.TFAutoModelForCausalLM.from_pretrained` class
    method or the :meth:`~transformerslora.TFAutoModelForCausalLM.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForCausalLM.from_pretrained` to load the model
            weights.
...
class TFAutoModelForMaskedLM:
    ...
    language modeling head---when created with the :meth:`~transformerslora.TFAutoModelForMaskedLM.from_pretrained` class
    method or the :meth:`~transformerslora.TFAutoModelForMaskedLM.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForMaskedLM.from_pretrained` to load the model
            weights.
...
class TFAutoModelForSeq2SeqLM:
    ...
    :meth:`~transformerslora.TFAutoModelForSeq2SeqLM.from_pretrained` class method or the
    :meth:`~transformerslora.TFAutoModelForSeq2SeqLM.from_config` class method.
    ...
    def from_config(cls, config, **kwargs):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForSeq2SeqLM.from_pretrained` to load the model
            weights.
...
class TFAutoModelForSequenceClassification(object):
    ...
    :meth:`~transformerslora.TFAutoModelForSequenceClassification.from_pretrained` class method or the
    :meth:`~transformerslora.TFAutoModelForSequenceClassification.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForSequenceClassification.from_pretrained` to
...
class TFAutoModelForQuestionAnswering(object):
    ...
    :meth:`~transformerslora.TFAutoModeForQuestionAnswering.from_pretrained` class method or the
    :meth:`~transformerslora.TFAutoModelForQuestionAnswering.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForQuestionAnswering.from_pretrained` to load
            the model weights.
...
class TFAutoModelForTokenClassification:
    ...
    classification head---when created with the :meth:`~transformerslora.TFAutoModelForTokenClassification.from_pretrained`
    class method or the :meth:`~transformerslora.TFAutoModelForTokenClassification.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForTokenClassification.from_pretrained` to load
            the model weights.
...
class TFAutoModelForMultipleChoice:
    ...
    :meth:`~transformerslora.TFAutoModelForMultipleChoice.from_pretrained` class method or the
    :meth:`~transformerslora.TFAutoModelForMultipleChoice.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForMultipleChoice.from_pretrained` to load the
            model weights.
...
class TFAutoModelForNextSentencePrediction:
    ...
    :meth:`~transformerslora.TFAutoModelForNextSentencePrediction.from_pretrained` class method or the
    :meth:`~transformerslora.TFAutoModelForNextSentencePrediction.from_config` class method.
    ...
    def from_config(cls, config):
        ...
        Note:
            Loading a model from its configuration file does **not** load the model weights. It only affects the
            model's configuration. Use :meth:`~transformerslora.TFAutoModelForNextSentencePrediction.from_pretrained` to
            load the model weights.
