...
GPT2_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.GPT2Config`): Model configuration class with all the parameters of the model.
...
GPT2_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`(batch_size, input_ids_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.GPT2Tokenizer`. See
...
@add_start_docstrings(
    ...
    :class:`~transformerslora.TFGPT2ForSequenceClassification` uses the last token in order to do the classification, as
