...
class BlenderbotSmallConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.BlenderbotSmallModel`. It is
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            represented by the :obj:`inputs_ids` passed when calling :class:`~transformerslora.BlenderbotSmallModel` or
            :class:`~transformerslora.TFBlenderbotSmallModel`.
