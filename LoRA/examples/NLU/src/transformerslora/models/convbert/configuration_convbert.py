...
class ConvBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.ConvBertModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformerslora.ConvBertModel` or
            :class:`~transformerslora.TFConvBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformerslora.ConvBertModel`
            or :class:`~transformerslora.TFConvBertModel`.
