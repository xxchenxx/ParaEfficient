...
class ReformerConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.ReformerModel`. It is used to
    ...
    Args:
        ...
        is_decoder (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            :class:`~transformerslora.ReformerModel`. When using the Reformer for causal language modeling, this argument
        ...
        vocab_size (:obj:`int`, `optional`, defaults to 320):\
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.ReformerModel`.
