...
class MBartTokenizer(XLMRobertaTokenizer):
    ...
    :class:`~transformerslora.MBartTokenizer` is a subclass of :class:`~transformerslora.XLMRobertaTokenizer`. Refer to
    superclass :class:`~transformerslora.XLMRobertaTokenizer` for usage examples and documentation concerning the
