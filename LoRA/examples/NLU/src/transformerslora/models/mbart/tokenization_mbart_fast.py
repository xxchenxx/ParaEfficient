...
class MBartTokenizerFast(XLMRobertaTokenizerFast):
    ...
    :class:`~transformerslora.MBartTokenizerFast` is a subclass of :class:`~transformerslora.XLMRobertaTokenizerFast`. Refer to
    superclass :class:`~transformerslora.XLMRobertaTokenizerFast` for usage examples and documentation concerning the
