...
# Copied from transformerslora.models.bart.modeling_tf_bart.TFBartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from transformerslora.models.bart.modeling_tf_bart.TFBartAttention with Bart->MBart
...
MBART_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformerslora.MBartConfig`): Model configuration class with all the parameters of the model.
...
MBART_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.MBartTokenizer`. See
