...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    def _reorder_cache(past: Tuple[Tuple[torch.Tensor]], beam_idx: torch.Tensor) -> Tuple[Tuple[torch.Tensor]]:
        ...
        :meth:`~transformerslora.PretrainedModel.beam_search` or :meth:`~transformerslora.PretrainedModel.beam_sample` is
...
@add_start_docstrings(
    ...
    :class:`~transformerslora.CTRLForSequenceClassification` uses the last token in order to do the classification, as
