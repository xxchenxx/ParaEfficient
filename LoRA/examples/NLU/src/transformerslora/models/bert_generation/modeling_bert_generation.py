...
BERT_GENERATION_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.BertGenerationConfig`): Model configuration class with all the parameters of the model.
...
BERT_GENERATION_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.BertGenerationTokenizer`. See
...
class BertGenerationEncoder(BertGenerationPreTrainedModel):
    ...
    :class:`~transformerslora.EncoderDecoderModel` class as described in `Leveraging Pre-trained Checkpoints for Sequence
