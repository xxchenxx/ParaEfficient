...
BART_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformerslora.BartConfig`): Model configuration class with all the parameters of the model.
...
BART_INPUTS_DOCSTRING = r"""
    Args:
        ...
        decoder_input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~transformerslora.BartTokenizer`. See
            :meth:`transformerslora.PreTrainedTokenizer.encode` and :meth:`transformerslora.PreTrainedTokenizer.__call__` for
            details.
