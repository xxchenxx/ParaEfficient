...
class XLMConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformerslora.XLMModel` or a
    :class:`~transformerslora.TFXLMModel`. It is used to instantiate a XLM model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30145):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.XLMModel` or :class:`~transformerslora.TFXLMModel`.
