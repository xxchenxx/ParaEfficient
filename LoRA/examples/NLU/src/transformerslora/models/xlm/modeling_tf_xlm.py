...
class TFXLMWithLMHeadModelOutput(ModelOutput):
    """
    Base class for :class:`~transformerslora.TFXLMWithLMHeadModel` outputs.
...
XLM_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.XLMConfig`): Model configuration class with all the parameters of the model.
