...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->Electra
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Electra
...
# Copied from from transformerslora.models.bert.modeling_tf_bert.TFBertAttention with Bert->Electra
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Electra
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertOutput with Bert->Electra
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertLayer with Bert->Electra
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertEncoder with Bert->Electra
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertPooler with Bert->Electra
...
# Copied from transformerslora.models.albert.modeling_tf_albert.TFAlbertEmbeddings with Albert->Electra
class TFElectraEmbeddings(tf.keras.layers.Layer):
    ...
    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertEmbeddings.call
    def call(
        self,
...
class TFElectraForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformerslora.TFElectraForPreTraining`.
...
ELECTRA_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~transformerslora.TFPreTrainedModel`. Check the superclass documentation for the
    ...
    Parameters:
        config (:class:`~transformerslora.ElectraConfig`): Model configuration class with all the parameters of the model.
...
ELECTRA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.ElectraTokenizer`. See
            :func:`transformerslora.PreTrainedTokenizer.__call__` and :func:`transformerslora.PreTrainedTokenizer.encode` for
            details.
        ...
        return_dict (:obj:`bool`, `optional`):
            Whether or not to return a :class:`~transformerslora.file_utils.ModelOutput` instead of a plain tuple. This
...
class TFElectraModel(TFElectraPreTrainedModel):
    ...
    # Copied from transformerslora.models.distilbert.modeling_tf_distilbert.TFDistilBertModel.serving_output
...
class TFElectraForMaskedLM(TFElectraPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertForMaskedLM.serving_output
...
class TFElectraForSequenceClassification(TFElectraPreTrainedModel, TFSequenceClassificationLoss):
    ...
    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertForSequenceClassification.serving_output
...
class TFElectraForMultipleChoice(TFElectraPreTrainedModel, TFMultipleChoiceLoss):
    ...
    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertForMultipleChoice.serving
    def serving(self, inputs: Dict[str, tf.Tensor]):
        output = self.call(input_ids=inputs)

        return self.serving_output(output)

    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertForMultipleChoice.serving_output
...
class TFElectraForTokenClassification(TFElectraPreTrainedModel, TFTokenClassificationLoss):
    ...
    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertForTokenClassification.serving_output
...
class TFElectraForQuestionAnswering(TFElectraPreTrainedModel, TFQuestionAnsweringLoss):
    ...
    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertForQuestionAnswering.serving_output
