...
class ElectraConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.ElectraModel` or a
    :class:`~transformerslora.TFElectraModel`. It is used to instantiate a ELECTRA model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.ElectraModel` or
            :class:`~transformerslora.TFElectraModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformerslora.ElectraModel` or
            :class:`~transformerslora.TFElectraModel`.
