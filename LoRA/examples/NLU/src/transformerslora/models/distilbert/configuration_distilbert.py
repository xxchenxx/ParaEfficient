...
class DistilBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.DistilBertModel` or a
    :class:`~transformerslora.TFDistilBertModel`. It is used to instantiate a DistilBERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformerslora.DistilBertModel` or
            :class:`~transformerslora.TFDistilBertModel`.
        ...
        qa_dropout (:obj:`float`, `optional`, defaults to 0.1):
            ...
            :class:`~transformerslora.DistilBertForQuestionAnswering`.
        seq_classif_dropout (:obj:`float`, `optional`, defaults to 0.2):
            The dropout probabilities used in the sequence classification and the multiple choice model
            :class:`~transformerslora.DistilBertForSequenceClassification`.
