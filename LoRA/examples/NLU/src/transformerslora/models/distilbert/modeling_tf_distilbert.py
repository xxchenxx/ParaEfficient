...
DISTILBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.DistilBertConfig`): Model configuration class with all the parameters of the model.
...
DISTILBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.DistilBertTokenizer`. See
