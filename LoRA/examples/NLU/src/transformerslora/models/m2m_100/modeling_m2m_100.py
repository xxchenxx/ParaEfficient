...
# Copied from transformerslora.models.bart.modeling_bart.BartAttention with Bart->M2M100
...
# Copied from transformerslora.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->M2M100
...
# Copied from transformerslora.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->M2M100
...
M2M_100_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.M2M100Config`):
...
M2M_100_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.M2M100Tokenizer`. See
...
class M2M100Encoder(M2M100PreTrainedModel):
    ...
    # Copied from transformerslora.models.mbart.modeling_mbart.MBartEncoder.forward with MBart->M2M100
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
class M2M100Decoder(M2M100PreTrainedModel):
    ...
    # Copied from transformerslora.models.mbart.modeling_mbart.MBartDecoder.forward with MBart->M2M100
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
