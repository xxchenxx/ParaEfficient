...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertPooler with Bert->MPNet
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->MPNet
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertOutput with Bert->MPNet
...
MPNET_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformerslora.MPNetConfig`): Model configuration class with all the parameters of the model.
...
MPNET_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.MPNetTokenizer`. See
