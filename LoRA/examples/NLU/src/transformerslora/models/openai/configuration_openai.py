...
class OpenAIGPTConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformerslora.OpenAIGPTModel` or a
    :class:`~transformerslora.TFOpenAIGPTModel`. It is used to instantiate a GPT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 40478):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.OpenAIGPTModel` or
            :class:`~transformerslora.TFOpenAIGPTModel`.
        ...
        summary_type (:obj:`str`, `optional`, defaults to :obj:`"cls_index"`):
            ...
            :class:`~transformerslora.OpenAIGPTDoubleHeadsModel` and :class:`~transformerslora.OpenAIGPTDoubleHeadsModel`.
