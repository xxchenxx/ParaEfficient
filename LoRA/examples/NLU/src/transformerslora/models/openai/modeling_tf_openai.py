...
OPENAI_GPT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.OpenAIGPTConfig`): Model configuration class with all the parameters of the model.
...
OPENAI_GPT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.OpenAIGPTTokenizer`. See
...
class TFOpenAIGPTLMHeadModel(TFOpenAIGPTPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertLMHeadModel.serving_output
...
@add_start_docstrings(
    ...
    :class:`~transformerslora.TFOpenAIGPTForSequenceClassification` uses the last token in order to do the classification,
