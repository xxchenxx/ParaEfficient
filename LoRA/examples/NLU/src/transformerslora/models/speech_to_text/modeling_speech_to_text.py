...
# Copied from transformerslora.models.bart.modeling_bart.BartAttention with Bart->Speech2Text
...
SPEECH_TO_TEXT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.Speech2TextConfig`):
...
SPEECH_TO_TEXT_INPUTS_DOCSTRING = r"""
    Args:
        input_features (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length, feature_size)`):
            ...
            into :obj:`input_features`, the :class:`~transformerslora.Speech2TextTokenizer` should be used for extracting
            the fbank features, padding and conversion into a tensor of type :obj:`torch.FloatTensor`. See
            :meth:`~transformerslora.Speech2TextTokenizer.__call__`
    ...
    def forward(
        ...
        Args:
            input_features (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length, feature_size)`):
                ...
                array into :obj:`input_features`, the :class:`~transformerslora.Speech2TextTokenizer` should be used for
                extracting the fbank features, padding and conversion into a tensor of type :obj:`torch.FloatTensor`.
                See :meth:`~transformerslora.Speech2TextTokenizer.__call__`
            attention_mask (:obj:`torch.Tensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
...
class Speech2TextDecoder(Speech2TextPreTrainedModel):
    ...
    # Copied from transformerslora.models.mbart.modeling_mbart.MBartDecoder.forward with MBart->Speech2Text
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
        ...
        Args:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~transformerslora.Speech2TextTokenizer`. See
