...
class Speech2TextConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.Speech2TextModel`. It is used
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformerslora.Speech2TextModel`
