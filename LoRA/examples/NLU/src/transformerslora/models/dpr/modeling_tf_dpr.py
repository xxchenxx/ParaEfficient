...
class TFDPRContextEncoderOutput(ModelOutput):
    r"""
    Class for outputs of :class:`~transformerslora.TFDPRContextEncoder`.
...
class TFDPRQuestionEncoderOutput(ModelOutput):
    """
    Class for outputs of :class:`~transformerslora.TFDPRQuestionEncoder`.
...
class TFDPRReaderOutput(ModelOutput):
    """
    Class for outputs of :class:`~transformerslora.TFDPRReaderEncoder`.
...
TF_DPR_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.DPRConfig`): Model configuration class with all the parameters of the model.
...
TF_DPR_ENCODERS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.DPRTokenizer`. See
...
TF_DPR_READER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids: (:obj:`Numpy array` or :obj:`tf.Tensor` of shapes :obj:`(n_passages, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.DPRReaderTokenizer`. See this class documentation for
            more details.
