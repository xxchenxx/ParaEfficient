...
class DPRContextEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~transformerslora.DPRContextEncoderTokenizerFast` is identical to :class:`~transformerslora.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~transformerslora.BertTokenizerFast` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~transformerslora.DPRQuestionEncoderTokenizerFast` is identical to :class:`~transformerslora.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.
...
class DPRReaderTokenizerFast(CustomDPRReaderTokenizerMixin, BertTokenizerFast):
    ...
    :class:`~transformerslora.DPRReaderTokenizerFast` is almost identical to :class:`~transformerslora.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs
    strings: question, titles and texts that are combined to be fed to the :class:`~transformerslora.DPRReader` model.
