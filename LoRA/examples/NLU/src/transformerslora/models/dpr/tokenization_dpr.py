...
class DPRContextEncoderTokenizer(BertTokenizer):
    ...
    :class:`~transformerslora.DPRContextEncoderTokenizer` is identical to :class:`~transformerslora.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~transformerslora.BertTokenizer` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizer(BertTokenizer):
    ...
    :class:`~transformerslora.DPRQuestionEncoderTokenizer` is identical to :class:`~transformerslora.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.
...
class DPRReaderTokenizer(CustomDPRReaderTokenizerMixin, BertTokenizer):
    ...
    :class:`~transformerslora.DPRReaderTokenizer` is almost identical to :class:`~transformerslora.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs strings:
    question, titles and texts that are combined to be fed to the :class:`~transformerslora.DPRReader` model.
