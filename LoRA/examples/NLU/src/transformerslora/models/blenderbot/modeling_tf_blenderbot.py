...
# Copied from transformerslora.models.bart.modeling_tf_bart.TFBartAttention with Bart->Blenderbot
...
# Copied from transformerslora.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Blenderbot
...
# Copied from transformerslora.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformerslora.BlenderbotConfig`): Model configuration class with all the parameters of the model.
...
BLENDERBOT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.BlenderbotTokenizer`. See
