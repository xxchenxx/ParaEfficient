...
# Copied from transformerslora.models.bart.modeling_bart.BartAttention with Bart->Blenderbot
...
# Copied from transformerslora.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Blenderbot
...
# Copied from transformerslora.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.BlenderbotConfig`):
...
# Copied from transformerslora.models.bart.modeling_bart.BartDecoderWrapper with Bart->Blenderbot
...
# Copied from transformerslora.models.bart.modeling_bart.BartForCausalLM with Bart->Blenderbot
