...
if TYPE_CHECKING:
    from transformerslora.pipelines.conversational import Conversation
...
class BlenderbotTokenizer(RobertaTokenizer):
    ...
    :class:`~transformerslora.Blenderbot` is nearly identical to :class:`~transformerslora.RobertaTokenizer` and runs
    ...
    Refer to superclass :class:`~transformerslora.RobertaTokenizer` for usage examples and documentation concerning
    parameters.
    """
