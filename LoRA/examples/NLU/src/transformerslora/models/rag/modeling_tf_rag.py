    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs
        ...
        Params:
            question_encoder_pretrained_model_name_or_path (:obj: `str`, `optional`):
                Information necessary to initiate the question encoder. Can be either:
                    ...
                    - A path to a `directory` containing model weights saved using
                      :func:`~transformerslora.TFPreTrainedModel.save_pretrained`, e.g., ``./my_model_directory/``.
            ...
            retriever (:class:`~transformerslora.RagRetriever`, `optional`):
...
RAG_START_DOCSTRING = r"""
    ...
    The question encoder can be any `autoencoding` model, preferably :class:`~transformerslora.TFDPRQuestionEncoder`, and
    the generator can be any `seq2seq` model, preferably :class:`~transformerslora.TFBartForConditionalGeneration`.

    The model can be initialized with a :class:`~transformerslora.RagRetriever` for end-to-end generation or used in
    ...
    the ``generator``. It has been tested with :class:`~transformerslora.TFDPRQuestionEncoder` as the ``question_encoder``
    and :class:`~transformerslora.TFBartForConditionalGeneration` as the ``generator``.
    ...
    Args:
        config (:class:`~transformerslora.RagConfig`):
            ...
            :meth:`~transformerslora.TFPreTrainedModel.from_pretrained` method to load the model weights.
        question_encoder (:class:`transformerslora.TFPreTrainedModel`):
            An encoder model compatible with the faiss index encapsulated by the ``retriever``.
        generator (:class:`transformerslora.TFPreTrainedModel`):
            A seq2seq model used as the generator in the RAG architecture.
        retriever (:class:`~transformerslora.RagRetriever`):
...
RAG_FORWARD_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            Indices of input sequence tokens in the vocabulary. :class:`~transformerslora.RagConfig`, used to initialize
        ...
        encoder_outputs (:obj:`tuple(tuple(tf.Tensor)`, `optional`)
            ...
            Used by the (:class:`~transformerslora.TFRagModel`) model during decoding.
        ...
        past_key_values (:obj:`tuple(tuple(tf.Tensor))`):
            ...
            :obj:`past_key_values` are used in the (:class:`~transformerslora.RagTokenForGeneration`) model during
            decoding.
        doc_scores (:obj:`tf.Tensor` of shape :obj:`(batch_size, config.n_docs)`):
            Score between each retrieved document embeddings (see :obj:`retrieved_doc_embeds`) and
        ...
        context_input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size * config.n_docs, config.max_combined_length)`, `optional`, returned when `output_retrieved=True`):
            ...
            forward pass. :obj:`context_input_ids` are returned by :meth:`~transformerslora.RagRetriever.__call__`.
        context_attention_mask (:obj:`tf.Tensor` of shape :obj:`(batch_size * config.n_docs, config.max_combined_length)`, `optional`, returned when `output_retrieved=True`):
            Attention mask post-processed from the retrieved documents and the question encoder :obj:`input_ids` by the
            retriever.
            ...
            :meth:`~transformerslora.RagRetriever.__call__`.
        ...
        **kwargs
        ...
        Args:
            ...
            num_return_sequences(:obj:`int`, `optional`, defaults to 1):
                ...
                is not the value we pass to the ``generator``'s `:func:`~transformerslora.PreTrainedModel.generate`
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def generate(
        ...
        **model_kwargs
        ...
        """
        Implements RAG sequence "thorough" decoding. Read the :meth:`~transformerslora.PreTrainedModel.generate``
        ...
        Args:
            ...
            context_attention_mask (:obj:`tf.Tensor` of shape :obj:`(batch_size * config.n_docs, config.max_combined_length)`, `optional`, returned when `output_retrieved=True`):
                ...
                They are returned by :meth:`~transformerslora.RagRetriever.__call__`.
            doc_scores (:obj:`tf.Tensor` of shape :obj:`(batch_size, config.n_docs)`):
                Score between each retrieved document embeddings (see :obj:`retrieved_doc_embeds`) and
                ...
                are returned by :meth:`~transformerslora.RagRetriever.__call__`.
            ...
            n_docs (:obj:`int`, `optional`, defaults to :obj:`config.n_docs`)
                Number of documents to retrieve and/or number of documents for which to generate an answer.
            kwargs:
                Additional kwargs will be passed to :meth:`~transformerslora.PreTrainedModel.generate`
