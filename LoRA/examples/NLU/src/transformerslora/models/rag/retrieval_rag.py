...
class Index:
    """
    A base class for the Indices encapsulated by the :class:`~transformerslora.RagRetriever`.
    """
    ...
    def __call__(
        ...
        Args:
            ...
            n_docs (:obj:`int`, `optional`):
                The number of docs retrieved per query.
            return_tensors (:obj:`str` or :class:`~transformerslora.file_utils.TensorType`, `optional`, defaults to "pt"):
        ...
        Returns: :class:`~transformerslora.BatchEncoding`: A :class:`~transformerslora.BatchEncoding` with the following
        fields:
