...
RAG_CONFIG_DOC = r"""
    :class:`~transformerslora.RagConfig` stores the configuration of a `RagModel`. Configuration objects inherit from
    :class:`~transformerslora.PretrainedConfig` and can be used to control the model outputs. Read the documentation from
    :class:`~transformerslora.PretrainedConfig` for more information.
    ...
    Args:
        title_sep (:obj:`str`, `optional`, defaults to  ``" / "``):
            ...
            :class:`~transformerslora.RagRetriever`.
        ...
        max_combined_length (:obj:`int`, `optional`, defaults to 300):
            Max length of contextualized input returned by :meth:`~transformerslora.RagRetriever.__call__`.
        retrieval_vector_size (:obj:`int`, `optional`, defaults to 768):
            Dimensionality of the document embeddings indexed by :class:`~transformerslora.RagRetriever`.
        ...
        passages_path: (:obj:`str`, `optional`):
            ...
            :class:`~transformerslora.models.rag.retrieval_rag.LegacyIndex`
...
class RagConfig(PretrainedConfig):
    ...
    def from_question_encoder_generator_configs(
        ...
        r"""
        Instantiate a :class:`~transformerslora.EncoderDecoderConfig` (or a derived class) from a pre-trained encoder model
    ...
    def to_dict(self):
        ...
        :meth:`~transformerslora.PretrainedConfig.to_dict`.
