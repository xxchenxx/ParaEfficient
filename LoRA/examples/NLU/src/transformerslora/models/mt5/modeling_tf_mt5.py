...
class TFMT5Model(TFT5Model):
    r"""
    This class overrides :class:`~transformerslora.TFT5Model`. Please check the superclass for the appropriate
...
class TFMT5ForConditionalGeneration(TFT5ForConditionalGeneration):
    r"""
    This class overrides :class:`~transformerslora.TFT5ForConditionalGeneration`. Please check the superclass for the
...
class TFMT5EncoderModel(TFT5EncoderModel):
    r"""
    This class overrides :class:`~transformerslora.TFT5EncoderModel`. Please check the superclass for the appropriate
    documentation alongside usage examples.
