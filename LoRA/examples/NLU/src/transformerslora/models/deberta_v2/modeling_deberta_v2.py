...
# Copied from transformerslora.models.deberta.modeling_deberta.ContextPooler
...
# Copied from transformerslora.models.deberta.modeling_deberta.XSoftmax with deberta->deberta_v2
class XSoftmax(torch.autograd.Function):
    ...
    Example::
          ...
          >>> import torch
          >>> from transformerslora.models.deberta_v2.modeling_deberta_v2 import XSoftmax
...
# Copied from transformerslora.models.deberta.modeling_deberta.DropoutContext
...
# Copied from transformerslora.models.deberta.modeling_deberta.get_mask
...
# Copied from transformerslora.models.deberta.modeling_deberta.XDropout
...
# Copied from transformerslora.models.deberta.modeling_deberta.StableDropout
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaSelfOutput with DebertaLayerNorm->LayerNorm
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaAttention with Deberta->DebertaV2
...
# Copied from transformerslora.models.bert.modeling_bert.BertIntermediate with Bert->DebertaV2
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaOutput with DebertaLayerNorm->LayerNorm
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaLayer with Deberta->DebertaV2
...
@torch.jit.script
# Copied from transformerslora.models.deberta.modeling_deberta.c2p_dynamic_expand
def c2p_dynamic_expand(c2p_pos, query_layer, relative_pos):
    return c2p_pos.expand([query_layer.size(0), query_layer.size(1), query_layer.size(2), relative_pos.size(-1)])


@torch.jit.script
# Copied from transformerslora.models.deberta.modeling_deberta.p2c_dynamic_expand
def p2c_dynamic_expand(c2p_pos, query_layer, key_layer):
    return c2p_pos.expand([query_layer.size(0), query_layer.size(1), key_layer.size(-2), key_layer.size(-2)])


@torch.jit.script
# Copied from transformerslora.models.deberta.modeling_deberta.pos_dynamic_expand
...
class DisentangledSelfAttention(torch.nn.Module):
    ...
    Parameters:
        config (:obj:`DebertaV2Config`):
            ...
            `BertConfig`, for more details, please refer :class:`~transformerslora.DebertaV2Config`
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaEmbeddings with DebertaLayerNorm->LayerNorm
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaPreTrainedModel with Deberta->DebertaV2
...
DEBERTA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.DebertaV2Config`): Model configuration class with all the parameters of the model.
...
DEBERTA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`{0}`):
            ...
            Indices can be obtained using :class:`transformerslora.DebertaV2Tokenizer`. See
            :func:`transformerslora.PreTrainedTokenizer.encode` and :func:`transformerslora.PreTrainedTokenizer.__call__` for
            details.
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaModel with Deberta->DebertaV2
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaForMaskedLM with Deberta->DebertaV2
...
# copied from transformerslora.models.bert.BertPredictionHeadTransform with bert -> deberta
...
# copied from transformerslora.models.bert.BertLMPredictionHead with bert -> deberta
...
# copied from transformerslora.models.bert.BertOnlyMLMHead with bert -> deberta
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaForSequenceClassification with Deberta->DebertaV2
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaForTokenClassification with Deberta->DebertaV2
...
# Copied from transformerslora.models.deberta.modeling_deberta.DebertaForQuestionAnswering with Deberta->DebertaV2
