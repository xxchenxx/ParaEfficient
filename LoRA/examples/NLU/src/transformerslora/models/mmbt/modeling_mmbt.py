...
MMBT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.MMBTConfig`): Model configuration class with all the parameters of the model.
...
MMBT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        input_ids (``torch.LongTensor`` of shape ``(batch_size, sequence_length)``):
            ...
            :class:`~transformerslora.BertTokenizer`. See :meth:`transformerslora.PreTrainedTokenizer.encode` and
