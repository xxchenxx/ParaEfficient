...
class XLNetConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformerslora.XLNetModel` or a
    :class:`~transformerslora.TFXLNetModel`. It is used to instantiate a XLNet model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 32000):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.XLNetModel` or
            :class:`~transformerslora.TFXLNetModel`.
