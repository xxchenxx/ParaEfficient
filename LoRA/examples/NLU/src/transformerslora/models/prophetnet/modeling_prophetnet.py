...
PROPHETNET_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.ProphetNetConfig`): Model configuration class with all the parameters of the model.
...
PROPHETNET_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.ProphetNetTokenizer`. See
...
class ProphetNetEncoder(ProphetNetPreTrainedModel):
    ...
    word_embeddings  (:obj:`torch.nn.Embeddings` of shape :obj:`(config.vocab_size, config.hidden_size)`, `optional`):
        The word embedding parameters. This can be used to initialize :class:`~transformerslora.ProphetNetEncoder` with
...
class ProphetNetForConditionalGeneration(ProphetNetPreTrainedModel):
    ...
    @staticmethod
    # Copied from transformerslora.models.bart.modeling_bart.BartForConditionalGeneration._reorder_cache
...
class ProphetNetForCausalLM(ProphetNetPreTrainedModel):
    ...
    @staticmethod
    # Copied from transformerslora.models.bart.modeling_bart.BartForCausalLM._reorder_cache
    def _reorder_cache(past, beam_idx):
        reordered_past = ()
        for layer_past in past:
...
class ProphetNetDecoderWrapper(ProphetNetPreTrainedModel):
    """
    This is a wrapper class, so that :class:`~transformerslora.ProphetNetForCausalLM` can correctly be loaded from
