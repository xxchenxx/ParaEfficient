...
class TFLxmertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformerslora.LxmertForPreTraining`.
...
LXMERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.LxmertConfig`): Model configuration class with all the parameters of the model.
...
LXMERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`np.ndarray` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.LxmertTokenizer`. See
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertPredictionHeadTransform with Bert->Lxmert
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertLMPredictionHead with Bert->Lxmert
...
# Copied from transformerslora.models.bert.modeling_tf_bert.TFBertMLMHead with Bert->Lxmert
