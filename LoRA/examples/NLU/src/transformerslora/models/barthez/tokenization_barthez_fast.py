...
class BarthezTokenizerFast(PreTrainedTokenizerFast):
    """
    Adapted from :class:`~transformerslora.CamembertTokenizer` and :class:`~transformerslora.BartTokenizer`. Construct a "fast"
    BARThez tokenizer. Based on `SentencePiece <https://github.com/google/sentencepiece>`__.

    This tokenizer inherits from :class:`~transformerslora.PreTrainedTokenizerFast` which contains most of the main
