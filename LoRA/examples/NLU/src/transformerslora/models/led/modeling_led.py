...
# Copied from transformerslora.models.longformer.modeling_longformer.LongformerSelfAttention with Longformer->LEDEncoder
...
@dataclass
# Copied from transformerslora.models.longformer.modeling_longformer.LongformerBaseModelOutput with Longformer->LEDEncoder
...
LED_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.LEDConfig`):
