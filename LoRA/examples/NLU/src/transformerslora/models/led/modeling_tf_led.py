...
# Copied from transformerslora.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from transformerslora.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
LED_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformerslora.LEDConfig`): Model configuration class with all the parameters of the model.
...
LED_INPUTS_DOCSTRING = r"""
    Args:
        ...
        decoder_input_ids (:obj:`tf.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~transformerslora.LedTokenizer`. See
            :meth:`transformerslora.PreTrainedTokenizer.encode` and :meth:`transformerslora.PreTrainedTokenizer.__call__` for
            details.
    ...
    def call(
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
                provide it. Indices can be obtained using :class:`~transformerslora.LEDTokenizer`. See
                :meth:`transformerslora.PreTrainedTokenizer.encode` and :meth:`transformerslora.PreTrainedTokenizer.__call__`
