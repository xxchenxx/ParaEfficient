...
TRANSFO_XL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.TransfoXLConfig`): Model configuration class with all the parameters of the model.
...
@add_start_docstrings(
    ...
    :class:`~transformerslora.TFTransfoXLForSequenceClassification` uses the last token in order to do the classification,
