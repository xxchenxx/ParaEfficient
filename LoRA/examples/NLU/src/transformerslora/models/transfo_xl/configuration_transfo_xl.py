...
class TransfoXLConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformerslora.TransfoXLModel` or a
    :class:`~transformerslora.TFTransfoXLModel`. It is used to instantiate a Transformer-XL model according to the
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 267735):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.TransfoXLModel` or
            :class:`~transformerslora.TFTransfoXLModel`.
