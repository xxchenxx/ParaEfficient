...
TRANSFO_XL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.TransfoXLTokenizer`. See
...
@add_start_docstrings(
    ...
    :class:`~transformerslora.TransfoXLForSequenceClassification` uses the last token in order to do the classification, as
