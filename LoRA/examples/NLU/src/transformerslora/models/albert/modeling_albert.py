...
class AlbertAttention(nn.Module):
    ...
    # Copied from transformerslora.models.bert.modeling_bert.BertSelfAttention.transpose_for_scores
...
class AlbertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformerslora.AlbertForPreTraining`.
