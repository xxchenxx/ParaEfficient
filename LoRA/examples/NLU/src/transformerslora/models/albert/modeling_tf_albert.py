...
class TFAlbertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformerslora.TFAlbertForPreTraining`.
...
ALBERT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformerslora.AlbertConfig`): Model configuration class with all the parameters of the model.
...
ALBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.AlbertTokenizer`. See
