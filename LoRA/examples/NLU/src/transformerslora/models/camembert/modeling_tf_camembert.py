...
CAMEMBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.CamembertConfig`): Model configuration class with all the parameters of the
...
class TFCamembertForQuestionAnswering(TFRobertaForQuestionAnswering):
    """
    This class overrides :class:`~transformerslora.TFRobertaForQuestionAnswering`. Please check the superclass for the
    appropriate documentation alongside usage examples.
    """
