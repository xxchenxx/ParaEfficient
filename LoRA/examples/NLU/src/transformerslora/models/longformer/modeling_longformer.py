...
# Copied from transformerslora.models.roberta.modeling_roberta.RobertaLMHead with Roberta->Longformer
...
LONGFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.LongformerConfig`): Model configuration class with all the parameters of the
...
class LongformerModel(LongformerPreTrainedModel):
    """
    This class copied code from :class:`~transformerslora.RobertaModel` and overwrote standard self-attention with
