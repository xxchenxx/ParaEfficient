...
class LongformerConfig(RobertaConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.LongformerModel` or a
    :class:`~transformerslora.TFLongformerModel`. It is used to instantiate a Longformer model according to the specified
    arguments, defining the model architecture.

    This is the configuration class to store the configuration of a :class:`~transformerslora.LongformerModel`. It is used
    ...
    The :class:`~transformerslora.LongformerConfig` class directly inherits :class:`~transformerslora.RobertaConfig`. It reuses
