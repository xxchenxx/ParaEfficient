...
# Copied from transformerslora.models.bart.modeling_tf_bart.TFBartAttention with Bart->Marian
...
# Copied from transformerslora.models.bart.modeling_tf_bart.TFBartEncoderLayer with Bart->Marian
...
# Copied from transformerslora.models.bart.modeling_tf_bart.TFBartDecoderLayer with Bart->Marian
...
MARIAN_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformerslora.MarianConfig`): Model configuration class with all the parameters of the model.
...
MARIAN_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.MarianTokenizer`. See
