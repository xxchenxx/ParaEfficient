...
class MarianConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.MarianModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.MarianModel` or
            :class:`~transformerslora.TFMarianModel`.
