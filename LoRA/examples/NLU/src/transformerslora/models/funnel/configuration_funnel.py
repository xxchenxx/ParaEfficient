...
class FunnelConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.FunnelModel` or a
    :class:`~transformerslora.TFBertModel`. It is used to instantiate a Funnel Transformer model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            by the :obj:`inputs_ids` passed when calling :class:`~transformerslora.FunnelModel` or
            :class:`~transformerslora.TFFunnelModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 3):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformerslora.FunnelModel` or
            :class:`~transformerslora.TFFunnelModel`.
