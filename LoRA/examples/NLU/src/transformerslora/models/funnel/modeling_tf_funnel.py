...
class TFFunnelForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformerslora.FunnelForPreTraining`.
...
FUNNEL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.XxxConfig`): Model configuration class with all the parameters of the model.
...
FUNNEL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.FunnelTokenizer`. See
