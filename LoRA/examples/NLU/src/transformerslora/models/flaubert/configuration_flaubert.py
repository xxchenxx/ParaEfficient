...
class FlaubertConfig(XLMConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformerslora.FlaubertModel` or a
    :class:`~transformerslora.TFFlaubertModel`. It is used to instantiate a FlauBERT model according to the specified
    ...
    Args:
        ...
        vocab_size (:obj:`int`, `optional`, defaults to 30145):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformerslora.FlaubertModel` or
            :class:`~transformerslora.TFFlaubertModel`.
