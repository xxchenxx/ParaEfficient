...
FLAUBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.FlaubertConfig`): Model configuration class with all the parameters of the model.
...
FLAUBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~transformerslora.FlaubertTokenizer`. See
...
# Copied from transformerslora.models.xlm.modeling_tf_xlm.TFXLMMultiHeadAttention with XLM->Flaubert
...
# Copied from transformerslora.models.xlm.modeling_tf_xlm.TFXLMTransformerFFN
...
# Copied from transformerslora.models.xlm.modeling_tf_xlm.TFXLMPredLayer
...
class TFFlaubertWithLMHeadModelOutput(ModelOutput):
    """
    Base class for :class:`~transformerslora.TFFlaubertWithLMHeadModel` outputs.
