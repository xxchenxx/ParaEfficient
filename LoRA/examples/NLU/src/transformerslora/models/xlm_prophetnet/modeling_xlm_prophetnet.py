...
class XLMProphetNetEncoder(ProphetNetEncoder):
    r"""
    This class overrides :class:`~transformerslora.ProphetNetEncoder`. Please check the superclass for the appropriate
...
class XLMProphetNetDecoder(ProphetNetDecoder):
    r"""
    This class overrides :class:`~transformerslora.ProphetNetDecoder`. Please check the superclass for the appropriate
    documentation alongside usage examples.
...
class XLMProphetNetModel(ProphetNetModel):
    r"""
    This class overrides :class:`~transformerslora.ProphetNetModel`. Please check the superclass for the appropriate
    documentation alongside usage examples.
...
class XLMProphetNetForConditionalGeneration(ProphetNetForConditionalGeneration):
    r"""
    This class overrides :class:`~transformerslora.ProphetNetForConditionalGeneration`. Please check the superclass for the
...
class XLMProphetNetForCausalLM(ProphetNetForCausalLM):
    r"""
    This class overrides :class:`~transformerslora.ProphetNetForCausalLM`. Please check the superclass for the appropriate
    documentation alongside usage examples.
