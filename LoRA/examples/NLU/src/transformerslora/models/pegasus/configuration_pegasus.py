...
class PegasusConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.PegasusModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.PegasusModel` or
            :class:`~transformerslora.TFPegasusModel`.
