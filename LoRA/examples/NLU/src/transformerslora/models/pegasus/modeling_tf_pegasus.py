...
# Copied from transformerslora.models.marian.modeling_tf_marian.TFMarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from transformerslora.models.bart.modeling_tf_bart.TFBartAttention with Bart->Pegasus
...
# Copied from transformerslora.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Pegasus
...
# Copied from transformerslora.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Pegasus
...
PEGASUS_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformerslora.PegasusConfig`): Model configuration class with all the parameters of the model.
...
PEGASUS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.PegasusTokenizer`. See
