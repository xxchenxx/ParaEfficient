...
FSMT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.FSMTConfig`): Model configuration class with all the parameters of the model.
...
FSMT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            IIndices can be obtained using :class:`~transformerslora.FSTMTokenizer`. See
