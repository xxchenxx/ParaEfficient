...
class Wav2Vec2CTCTokenizer(PreTrainedTokenizer):
    ...
    This tokenizer inherits from :class:`~transformerslora.PreTrainedTokenizer` which contains some of the main methods.
    ...
    Args:
        ...
        **kwargs
            Additional keyword arguments passed along to :class:`~transformerslora.PreTrainedTokenizer`
    """
...
class Wav2Vec2Tokenizer(PreTrainedTokenizer):
    ...
    Args:
        ...
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~transformerslora.Wav2Vec2Tokenizer.__call__` should return :obj:`attention_mask`.
    ...
    def __init__(
        ...
        **kwargs
        ...
        warnings.warn(
            "The class `Wav2Vec2Tokenizer` is deprecated and will be removed in version 5 of transformerslora. Please use `Wav2Vec2Processor` or `Wav2Vec2CTCTokenizer` instead.",
            FutureWarning,
        )
