...
# Copied from transformerslora.models.bart.modeling_bart.BartAttention with Bart->Wav2Vec2
...
WAV_2_VEC_2_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.Wav2Vec2Config`): Model configuration class with all the parameters of the model.
...
WAV_2_VEC_2_INPUTS_DOCSTRING = r"""
    Args:
        input_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            soundfile`). To prepare the array into `input_values`, the :class:`~transformerslora.Wav2Vec2Processor` should
            be used for padding and conversion into a tensor of type `torch.FloatTensor`. See
            :meth:`transformerslora.Wav2Vec2Processor.__call__` for details.
