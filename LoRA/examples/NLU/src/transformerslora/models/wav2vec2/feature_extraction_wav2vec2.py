...
class Wav2Vec2FeatureExtractor(SequenceFeatureExtractor):
    ...
    :class:`~transformerslora.feature_extraction_sequence_utils.SequenceFeatureExtractor` which contains most of the main
    ...
    Args:
        ...
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~transformerslora.Wav2Vec2FeatureExtractor.__call__` should return :obj:`attention_mask`.
