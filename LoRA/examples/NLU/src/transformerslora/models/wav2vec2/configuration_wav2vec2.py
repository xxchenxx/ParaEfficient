...
class Wav2Vec2Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.Wav2Vec2Model`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 32):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformerslora.Wav2Vec2Model` or
            :class:`~transformerslora.TFWav2Vec2Model`. Vocabulary size of the model. Defines the different tokens that can
            be represented by the `inputs_ids` passed to the forward method of :class:`~transformerslora.Wav2Vec2Model`.
        ...
        ctc_loss_reduction (:obj:`str`, `optional`, defaults to :obj:`"sum"`):
            ...
            instance of :class:`~transformerslora.Wav2Vec2ForCTC`.
