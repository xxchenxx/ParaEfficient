...
class TFMobileBertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformerslora.TFMobileBertForPreTraining`.
...
MOBILEBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.MobileBertConfig`): Model configuration class with all the parameters of the model.
...
MOBILEBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~transformerslora.MobileBertTokenizer`. See
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    # Copied from transformerslora.models.bert.modeling_tf_bert.TFBertForNextSentencePrediction.serving_output
