...
class MobileBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.MobileBertModel` or a
    :class:`~transformerslora.TFMobileBertModel`. It is used to instantiate a MobileBERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~transformerslora.MobileBertModel` or
            :class:`~transformerslora.TFMobileBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformerslora.MobileBertModel`
            or :class:`~transformerslora.TFMobileBertModel`.
