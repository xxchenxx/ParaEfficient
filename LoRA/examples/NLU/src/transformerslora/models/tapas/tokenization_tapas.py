...
class TapasTruncationStrategy(ExplicitEnum):
    """
    Possible values for the ``truncation`` argument in :meth:`~transformerslora.TapasTokenizer.__call__`. Useful for
...
TAPAS_ENCODE_PLUS_ADDITIONAL_KWARGS_DOCSTRING = r"""
            ...
            padding (:obj:`bool`, :obj:`str` or :class:`~transformerslora.file_utils.PaddingStrategy`, `optional`, defaults to :obj:`False`):
                ...
                * :obj:`False` or :obj:`'do_not_pad'` (default): No padding (i.e., can output a batch with sequences of
                  different lengths).
            truncation (:obj:`bool`, :obj:`str` or :class:`~transformerslora.TapasTruncationStrategy`, `optional`, defaults to :obj:`False`):
...
class TapasTokenizer(PreTrainedTokenizer):
    ...
    This tokenizer inherits from :class:`~transformerslora.PreTrainedTokenizer` which contains most of the main methods.
    Users should refer to this superclass for more information regarding those methods.
    :class:`~transformerslora.TapasTokenizer` creates several token type ids to encode tabular structure. To be more
    ...
    :class:`~transformerslora.TapasTokenizer` runs end-to-end tokenization on a table and associated sentences: punctuation
        ...
        **kwargs
        ...
        if return_offsets_mapping:
            raise NotImplementedError(
                ...
                "transformerslora.PreTrainedTokenizerFast."
            )
    ...
    def _get_truncated_table_rows(
        ...
        Args:
            ...
            truncation_strategy (:obj:`str` or :obj:`~transformerslora.TapasTruncationStrategy`):
    ...
    def convert_logits_to_predictions(self, data, logits, logits_agg=None, cell_classification_threshold=0.5):
        """
        Converts logits of :class:`~transformerslora.TapasForQuestionAnswering` to actual predicted answer coordinates and
        ...
        Args:
            data (:obj:`dict`):
                ...
                :class:`~transformerslora.TapasTokenizer`.
...
# Copied from transformerslora.models.bert.tokenization_bert.BasicTokenizer
...
# Copied from transformerslora.models.bert.tokenization_bert.WordpieceTokenizer
