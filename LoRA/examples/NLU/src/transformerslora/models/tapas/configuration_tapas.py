...
class TapasConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.TapasModel`. It is used to
    ...
    architecture. Configuration objects inherit from :class:`~transformerslora.PreTrainedConfig` and can be used to control
    the model outputs. Read the documentation from :class:`~transformerslora.PretrainedConfig` for more information.
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.TapasModel`.
        ...
        type_vocab_sizes (:obj:`List[int]`, `optional`, defaults to :obj:`[3, 256, 256, 2, 256, 256, 10]`):
            The vocabulary sizes of the :obj:`token_type_ids` passed when calling :class:`~transformerslora.TapasModel`.
