...
class TableQuestionAnsweringOutput(ModelOutput):
    """
    Output type of :class:`~transformerslora.TapasForQuestionAnswering`.
...
# Copied from transformerslora.models.bert.modeling_bert.BertSelfOutput
...
# Copied from transformerslora.models.bert.modeling_bert.BertAttention with Bert->Tapas
...
# Copied from transformerslora.models.bert.modeling_bert.BertIntermediate
...
# Copied from transformerslora.models.bert.modeling_bert.BertOutput
...
# Copied from transformerslora.models.bert.modeling_bert.BertLayer with Bert->Tapas
...
# Copied from transformerslora.models.bert.modeling_bert.BertPooler
...
class TapasPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformerslora.models.bert.modeling_bert.BertPreTrainedModel._init_weights
...
TAPAS_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.TapasConfig`): Model configuration class with all the parameters of the model.
...
TAPAS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            :class:`~transformerslora.TapasTokenizer`. See :meth:`transformerslora.PreTrainedTokenizer.encode` and
            :meth:`transformerslora.PreTrainedTokenizer.__call__` for details.
        ...
        token_type_ids (:obj:`torch.LongTensor` of shape :obj:`({0}, 7)`, `optional`):
            ...
            :class:`~transformerslora.TapasTokenizer`. See this class for more info.

            `What are token type IDs? <../glossary.html#token-type-ids>`_
        position_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`, `optional`):
            Indices of positions of each input sequence tokens in the position embeddings. If
            ``reset_position_index_per_cell`` of :class:`~transformerslora.TapasConfig` is set to ``True``, relative
...
class TapasModel(TapasPreTrainedModel):
    """
    This class is a small change compared to :class:`~transformerslora.BertModel`, taking into account the additional token
    type ids.
...
class TapasForQuestionAnswering(TapasPreTrainedModel):
    ...
    def forward(
        ...
        labels (:obj:`torch.LongTensor` of shape :obj:`(batch_size, seq_length)`, `optional`):
            ...
            answer appearing in the table. Can be obtained using :class:`~transformerslora.TapasTokenizer`.
        ...
        numeric_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, seq_length)`, `optional`):
            ...
            :class:`~transformerslora.TapasTokenizer`. Only required in case of weak supervision for aggregation (WTQ) to
            calculate the regression loss.
        numeric_values_scale (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, seq_length)`, `optional`):
            Scale of the numeric values of every token. Can be obtained using :class:`~transformerslora.TapasTokenizer`.
...
def _calculate_expected_result(
    ...
    Args:
        ...
        logits_aggregation (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_aggregation_labels)`):
            Logits per aggregation operation.
        config (:class:`~transformerslora.TapasConfig`):
