...
class DebertaConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformerslora.DebertaModel` or a
    :class:`~transformerslora.TFDebertaModel`. It is used to instantiate a DeBERTa model according to the specified
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformerslora.DebertaModel` or
            :class:`~transformerslora.TFDebertaModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformerslora.DebertaModel` or
            :class:`~transformerslora.TFDebertaModel`.
