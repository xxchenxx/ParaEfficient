...
class XSoftmax(torch.autograd.Function):
    ...
    Example::
          ...
          >>> import torch
          >>> from transformerslora.models.deberta.modeling_deberta import XSoftmax
...
# Copied from transformerslora.models.bert.modeling_bert.BertIntermediate with Bert->Deberta
...
class DisentangledSelfAttention(torch.nn.Module):
    ...
    Parameters:
        config (:obj:`str`):
            ...
            `BertConfig`, for more details, please refer :class:`~transformerslora.DebertaConfig`
...
DEBERTA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformerslora.DebertaConfig`): Model configuration class with all the parameters of the model.
...
DEBERTA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`{0}`):
            ...
            Indices can be obtained using :class:`transformerslora.DebertaTokenizer`. See
