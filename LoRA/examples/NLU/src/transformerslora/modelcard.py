...
class ModelCard:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        r"""
        Instantiate a :class:`~transformerslora.ModelCard` from a pre-trained model model card.
        ...
        Parameters:
            pretrained_model_name_or_path: either:
                ...
                - a path to a `directory` containing a model card file saved using the
                  :func:`~transformerslora.ModelCard.save_pretrained` method, e.g.: ``./my_model_directory/``.
