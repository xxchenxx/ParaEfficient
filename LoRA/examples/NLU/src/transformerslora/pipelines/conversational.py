...
class Conversation:
    ...
    :class:`~transformerslora.ConversationalPipeline`. The conversation contains a number of utility function to manage the
    addition of new user input and generated model responses. A conversation needs to contain an unprocessed user input
    before being passed to the :class:`~transformerslora.ConversationalPipeline`. This user input is either created when
    ...
    Arguments:
        text (:obj:`str`, `optional`):
            ...
            manually using the :meth:`~transformerslora.Conversation.add_user_input` method before the conversation can
            begin.
...
class ConversationalPipeline(Pipeline):
    ...
    This conversational pipeline can currently be loaded from :func:`~transformerslora.pipeline` using the following task
    ...
    def __call__(
        ...
        **generate_kwargs
        ...
        Args:
            conversations (a :class:`~transformerslora.Conversation` or a list of :class:`~transformerslora.Conversation`):
        ...
        Returns:
            :class:`~transformerslora.Conversation` or a list of :class:`~transformerslora.Conversation`: Conversation(s) with
