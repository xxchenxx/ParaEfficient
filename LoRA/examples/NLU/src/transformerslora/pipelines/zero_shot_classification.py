...
class ZeroShotClassificationPipeline(Pipeline):
    ...
    config's :attr:`~transformerslora.PretrainedConfig.label2id`.

    This NLI pipeline can currently be loaded from :func:`~transformerslora.pipeline` using the following task identifier:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        Classify the sequence(s) given as inputs. See the :obj:`~transformerslora.ZeroShotClassificationPipeline`
        ...
        if "multi_class" in kwargs and kwargs["multi_class"] is not None:
            ...
            logger.warn(
                ...
                "`multi_class` will be removed in a future version of transformerslora."
            )
