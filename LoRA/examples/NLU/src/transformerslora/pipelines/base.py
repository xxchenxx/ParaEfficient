...
def get_framework(model, revision: Optional[str] = None):
    ...
    Args:
        model (:obj:`str`, :class:`~transformerslora.PreTrainedModel` or :class:`~transformerslora.TFPreTrainedModel`):
...
class PipelineException(Exception):
    """
    Raised by a :class:`~transformerslora.Pipeline` when handling __call__.
...
class ArgumentHandler(ABC):
    """
    Base interface for handling arguments for each :class:`~transformerslora.pipelines.Pipeline`.
    """
...
class PipelineDataFormat:
    ...
    def save(self, data: Union[dict, List[dict]]):
        ...
        :class:`~transformerslora.pipelines.PipelineDataFormat`.
    ...
    def from_str(
        ...
        """
        Creates an instance of the right subclass of :class:`~transformerslora.pipelines.PipelineDataFormat` depending on
        :obj:`format`.
        ...
        Returns:
            :class:`~transformerslora.pipelines.PipelineDataFormat`: The proper data format.
        """
        if format == "json":
...
PIPELINE_INIT_ARGS = r"""
    Arguments:
        model (:obj:`~transformerslora.PreTrainedModel` or :obj:`~transformerslora.TFPreTrainedModel`):
            The model that will be used by the pipeline to make predictions. This needs to be a model inheriting from
            :class:`~transformerslora.PreTrainedModel` for PyTorch and :class:`~transformerslora.TFPreTrainedModel` for
            TensorFlow.
        tokenizer (:obj:`~transformerslora.PreTrainedTokenizer`):
            The tokenizer that will be used by the pipeline to encode data for the model. This object inherits from
            :class:`~transformerslora.PreTrainedTokenizer`.
        modelcard (:obj:`str` or :class:`~transformerslora.ModelCard`, `optional`):
        ...
        args_parser (:class:`~transformerslora.pipelines.ArgumentHandler`, `optional`):
...
class Pipeline(_ScikitCompat):
    ...
    Some pipeline, like for instance :class:`~transformerslora.FeatureExtractionPipeline` (:obj:`'feature-extraction'` )
