...
class QuestionAnsweringArgumentHandler(ArgumentHandler):
    ...
    internal :class:`~transformerslora.SquadExample`.

    QuestionAnsweringArgumentHandler manages all the possible to create a :class:`~transformerslora.SquadExample` from the
...
class QuestionAnsweringPipeline(Pipeline):
    ...
    This question answering pipeline can currently be loaded from :func:`~transformerslora.pipeline` using the following
    ...
    def create_sample(
        ...
        """
        QuestionAnsweringPipeline leverages the :class:`~transformerslora.SquadExample` internally. This helper method
        encapsulate all the logic for converting question(s) and context(s) to :class:`~transformerslora.SquadExample`.
        ...
        Returns:
            One or a list of :class:`~transformerslora.SquadExample`: The corresponding :class:`~transformerslora.SquadExample`
    ...
    def __call__(self, *args, **kwargs):
        ...
        Args:
            args (:class:`~transformerslora.SquadExample` or a list of :class:`~transformerslora.SquadExample`):
                One or several :class:`~transformerslora.SquadExample` containing the question and context.
            X (:class:`~transformerslora.SquadExample` or a list of :class:`~transformerslora.SquadExample`, `optional`):
                One or several :class:`~transformerslora.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
            data (:class:`~transformerslora.SquadExample` or a list of :class:`~transformerslora.SquadExample`, `optional`):
                One or several :class:`~transformerslora.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
