...
def pipeline(
    ...
    **kwargs
    ...
    """
    Utility factory method to build a :class:`~transformerslora.Pipeline`.
    ...
    Args:
        task (:obj:`str`):
            ...
            - :obj:`"feature-extraction"`: will return a :class:`~transformerslora.FeatureExtractionPipeline`.
            - :obj:`"sentiment-analysis"`: will return a :class:`~transformerslora.TextClassificationPipeline`.
            - :obj:`"ner"`: will return a :class:`~transformerslora.TokenClassificationPipeline`.
            - :obj:`"question-answering"`: will return a :class:`~transformerslora.QuestionAnsweringPipeline`.
            - :obj:`"fill-mask"`: will return a :class:`~transformerslora.FillMaskPipeline`.
            - :obj:`"summarization"`: will return a :class:`~transformerslora.SummarizationPipeline`.
            - :obj:`"translation_xx_to_yy"`: will return a :class:`~transformerslora.TranslationPipeline`.
            - :obj:`"text2text-generation"`: will return a :class:`~transformerslora.Text2TextGenerationPipeline`.
            - :obj:`"text-generation"`: will return a :class:`~transformerslora.TextGenerationPipeline`.
            - :obj:`"zero-shot-classification:`: will return a :class:`~transformerslora.ZeroShotClassificationPipeline`.
            - :obj:`"conversational"`: will return a :class:`~transformerslora.ConversationalPipeline`.
        model (:obj:`str` or :obj:`~transformerslora.PreTrainedModel` or :obj:`~transformerslora.TFPreTrainedModel`, `optional`):
            The model that will be used by the pipeline to make predictions. This can be a model identifier or an
            actual instance of a pretrained model inheriting from :class:`~transformerslora.PreTrainedModel` (for PyTorch)
            or :class:`~transformerslora.TFPreTrainedModel` (for TensorFlow).

            If not provided, the default for the :obj:`task` will be loaded.
        config (:obj:`str` or :obj:`~transformerslora.PretrainedConfig`, `optional`):
            The configuration that will be used by the pipeline to instantiate the model. This can be a model
            identifier or an actual pretrained model configuration inheriting from
            :class:`~transformerslora.PretrainedConfig`.
        ...
        tokenizer (:obj:`str` or :obj:`~transformerslora.PreTrainedTokenizer`, `optional`):
            The tokenizer that will be used by the pipeline to encode data for the model. This can be a model
            identifier or an actual pretrained tokenizer inheriting from :class:`~transformerslora.PreTrainedTokenizer`.
        ...
        use_fast (:obj:`bool`, `optional`, defaults to :obj:`True`):
            Whether or not to use a Fast tokenizer if possible (a :class:`~transformerslora.PreTrainedTokenizerFast`).
        model_kwargs:
    ...
    Returns:
        :class:`~transformerslora.Pipeline`: A suitable pipeline for the task.
