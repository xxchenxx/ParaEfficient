...
class SequenceFeatureExtractor(FeatureExtractionMixin):
    ...
    def pad(
        ...
        Args:
            processed_features (:class:`~transformerslora.BatchFeature`, list of :class:`~transformerslora.BatchFeature`, :obj:`Dict[str, List[float]]`, :obj:`Dict[str, List[List[float]]` or :obj:`List[Dict[str, List[float]]]`):
                Processed inputs. Can represent one input (:class:`~transformerslora.BatchFeature` or :obj:`Dict[str,
                List[float]]`) or a batch of input values / vectors (list of :class:`~transformerslora.BatchFeature`,
        ...
        if self.model_input_names[0] not in processed_features:
            raise ValueError(
                "You should supply an instance of :class:`~transformerslora.BatchFeature` or list of :class:`~transformerslora.BatchFeature` to this method"
